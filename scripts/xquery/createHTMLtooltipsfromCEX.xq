...
element span {
         ...
         element span {
           ...
           string-join(
           tokenize(
             string-join((local:getcropos($postag,$pos1,1),
           local:getcropos($postag,$pos2,2),
         local:getcropos($postag,$pos3,3),
       local:getcropos($postag,$pos4,4),
     local:getcropos($postag,$pos5,5),
   local:getcropos($postag,$pos6,6),
 local:getcropos($postag,$pos7,7),
local:getcropos($postag,$pos8,8)), " "), " +"
), ", "), ", $", ""), "_", " ")
         },
         element span {
