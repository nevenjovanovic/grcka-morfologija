% pet, 12.12.2025.  10:12:00 CET ujednačio zareze u citatima prema AM
% priredi prijelom <2026-02-14 sub>,,
...
\newfontfamily\greekfont[Mapping=TeX]{Old Standard TT}
\newfontfamily\greekfontsf[Script=Greek]{Old Standard TT}
\newfontfamily\greekfontbf[Script=Greek]{Old Standard TT}
...
\hyphenation{po-slije Ma-chia-vel-li-jevo dis-junk-tiv-no ap-strakt-na čet-ve-ro-stru-koj naj-zna-me-ni-ti-ji liječ-niš-tvo pod-rijet-lom post-po-zi-tiv-no-ga lije-pih prije-dlož-no-mu pod-ruč-ja kon-junk-ti-vu društ-vu ne-zbilj-nu pro-cije-ni-ti rije-či u-vrije-dio svije-ta prijed-lož-nim ad-verb-ni po-slan-stva}
...
% \author{Nina Čengić, Neven Jovanović, Petra Matović,\\Vladimir Rezar, Ninoslav Zubović}
% \date{}
% \maketitle
...
Ovaj izbor komentiranih tekstova čini propisanu literaturu obvezatnoga kolegija \textit{Grčka morfologija 2}. Kao i u \textit{Čitanci za Grčku morfologiju 1}, kratkim su odlomcima dodane tri vrste komentara. U uvodu su predstavljeni autor (kad se pojavljuje prvi put), tekst iz kojega odlomak potječe i kontekst samoga odlomka. Nakon teksta slijede rečenice, raščlanjene i složene tako da povećaju sintaktičku i semantičku preglednost, te gramatički komentar. Taj je komentar, opet, dvojak. U skladu sa sadržajem ovoga kolegija, za glagolske oblike donose se samo brojevi paragrafa koji upućuju studenta na relevantne dijelove \textit{Grčke gramatike} Augusta Musića i Nikole Majnarića, standardni školski priručnik za opis grčkoga jezika. Ostatak komentara objašnjava gramatičke, sintaktičke i stvarne aspekte koji bi mogli otežati razumijevanje teksta.

Zadatak je studenata da, s pomoću komentara i referentne literature, kod kuće prirede svaki tekst tako da ga na nastavi budu sposobni pročitati i prevesti na hrvatski te prepoznati i morfološki opisati glagolske oblike koje susreću. Također, očekuje se i da studenti nauče određeni broj riječi iz ovih tekstova s pomoću popisa i vježbi koje će naći na stranicama kolegija \textit{Grčka morfologija 2} Sustava učenja na daljinu Omega (Filozofski fakultet Sveučilišta u Zagrebu).

%\newpage

Izbor su sastavili i komentare priredili nastavnici Odsjeka za klasičnu filologiju Filozofskoga fakulteta Sveučilišta u Zagrebu (abecednim redom): Nina Čengić, Neven Jovanović, Petra Matović, Vladimir Rezar, Ninoslav Zubović. Čitanka je priređena računalnim programima za slaganje teksta LaTeX i XeLaTeX. Izvorni kod dostupan je u repozitoriju Github, na URL adresi \url{https://github.com/nevenjovanovic/grcka-morfologija}.

%\medskip

U Zagrebu prosinca 2025.
...
\textit{Grčka morfologija 2}, elektronička inačica kolegija, Sustav učenja na daljinu Omega, Zagreb: Filozofski fakultet Sveučilišta u Zagrebu, pristupljeno 23. kolovoza 2018. na adresi \url{https://omega.ffzg.hr/course/view.php?id=1615}.\\
...
\noindent Ovo je djelo ustupljeno pod Creative Commons licencom Imenovanje 3.0 nelokalizirana licenca. Da biste vidjeli primjerak te licence, posjetite \url{http://creativecommons.org/licenses/by/3.0/} ili pošaljite pismo na Creative Commons, PO Box 1866, Mountain View, CA 94042, SAD.
...
%,,,,,,
\chapter[Πολυβίου Ἱστορίων ΛΗ]{\textgreek[variant=ancient]{Πολυβίου ἱστορίων ΛΗ,} 22, 1–3}
%11
...
\chapter[Ξενοφῶντος Ἀπομνημονεύματα Σωκράτους]{\textgreek[variant=ancient]{Ξενοφῶντος \\Ἀπομνημονεύματα Σωκράτους \\Δ} 3, 3–6}
% 13
...
%,,,,
\chapter[Πλουτάρχου Ἀλκιβιάδης]{\textgreek[variant=ancient]{Πλουτάρχου Βίοι παράλληλοι, \\Ἀλκιβιάδης} 2, 1–3}
% 16
...
%,,,,
\chapter[Πλάτωνος Θεαίτητος]{\textgreek[variant=ancient]{Πλάτωνος Θεαίτητος} 173c–174a}
%31
...
\chapter[Δημοκρίτου ἀπόσπασμα ΡϘΑ]{\textgreek[variant=ancient]{Δημοκρίτου  ἀπόσπασμα ΡϘΑ \\(Περὶ εὐθυμίης)}}%koppa
...
\chapter[Γοργίου Ἐπιτάφιος]{\textgreek[variant=ancient]{Γοργίου Ἐπιταφίου ἀπόσπασμα Ϛ}}
\label{chap:gorgias}%svuda apospasma umjesto ekloge
