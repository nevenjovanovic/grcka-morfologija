...
% Unio, dopunio NJ <2022-01-08 sub>; unesi korekture AM <2026-01-15 čet>
...
U odabranome se odlomku nužnost osude Andokida argumentira nizom analogija: zločin svetogrđa uspoređuje se s kaznenim djelom tjelesne ozljede, govornik upozorava kako strogo drugi Grci kažnjavaju svetogrđe te kako su sami Atenjani bili strogi prema bezbožnomu strancu Dijagori. Govornik spominje Areopag \textgreek{(ἡ Βουλὴ ἡ τοῦ Ἀρείου πάγου),} najstariji sud u Ateni pred kojim se najčešće sudilo zbog ubojstva i ostalih krvnih delikata, te pojam atenskoga prava \textgreek{ἔνδειξις} (vrsta pokretanja optužnice u slučajevima zloporaba građanskoga prava). 
...
\item[τρώσῃ] §~267 
\item[τοὺς ἐξ Ἀρείου ⟨πάγου⟩] prijedložni izraz u (jače istaknutome) atributnom položaju §~375; prelomljene zagrade označavaju priređivačevu emendaciju (dodano je što je u rukopisnoj predaji izostavljeno)
...
\item[ἐνθάδε] prilog u atributnome položaju
