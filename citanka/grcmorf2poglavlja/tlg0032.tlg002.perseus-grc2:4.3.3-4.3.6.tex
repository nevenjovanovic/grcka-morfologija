...
% Unio korekture AM <2025-12-22 pon>, unesi ispravke NZ <2026-01-09 pet>
% \section*{O autoru}
...
Atenski pisac Ksenofont – plaćeni vojnik, povjesničar i filozof – bio je u mladosti i Sokratov učenik. I na Ksenofonta je, kao i na mnoge druge (Platona među njima), Sokrat ostavio dubok dojam. Poslije Sokratove smrti (399.\ pr.~Kr.), u nizu djela Ksenofont s raznih aspekata razmatra Sokratovo suđenje. To su takozvani sokratski spisi: \textgreek[variant=ancient]{Ἀπολογία Σωκράτους} (\textit{Obrana Sokratova}), \textgreek[variant=ancient]{Ἀπομνημονεύματα Σωκράτους} (\textit{Uspomene na Sokrata}), \textgreek[variant=ancient]{Συμπόσιον} (\textit{Gozba}) i \textgreek[variant=ancient]{Οἰκονομικός} (\textit{Rasprava o gospodarstvu}). Ksenofont nije osobno svjedočio sudskomu procesu Sokratu; u to je vrijeme bio u Perziji, kao grčki plaćenik u vojnome pohodu Kira Mlađega.

U četvrtoj knjizi \textit{Uspomena na Sokrata}, odakle potječe ovaj odlomak, Ksenofont Sokratove poglede na obrazovanje predstavlja dijalogom Sokrata i njegova učenika, lijepoga Eutidema. Razumnost ili umjerenost, \textgreek[variant=ancient]{σωφροσύνη,} prva je stvar koju Sokrat zahtijeva, a potrebna je i u odnosu prema bogovima. Opis načina na koji su bogovi ljudima uredili svijet smatra se jednim od najranijih primjera teleološkoga argumenta.

\newpage

\section*{Pročitajte naglas grčki tekst.}

Xen. Memorabilia 4.3.3–6
...
\item[ἐπῆλθεν] rekcija τίνι LSJ ἐπέρχομαι I. 3: „pasti komu na um''; §~254, §~333.C.13, §~327.2, §~460.1, §~454                                         
...
\item[νὴ Δί'] §~519.9
\item[ἔφη] §~312.8, §~39.3, §~327.7, §~460.1, §~452
\item[ὅ γ'] antecedent relativa i dalje je φῶς; ponovljeni relativ naglašava prethodni: „to\dots”
\item[γ'] < γε, §~519
...
\item[εἰ μὴ εἴχομεν\dots\ ἂν ἦμεν ὅμοιοι] pogodbena irealna rečenica za sadašnjost, u hrvatskome odgovara kombinaciji „da'' + prezent – kondicional I., §~478.1
...
\item[ἔφη] §~312.8
\item[τοῦτο\dots\ ἄξιον] u imenskome predikatu izostavljena kopula (ἐστιν)
\item[χάριτος] LSJ χάρις II, 2: sa strane onoga koji prima, posljedica učinjene usluge, zahvalnost
\end{description}
...
\item[εἶναι] §~315, §~490
\item[διὰ τὸ σκοτεινὴ εἶναι] prijedložni izraz sa poimeničenim infinitivom, §~497
\item[ἐστίν] §~315
\item[ἀσαφεστέρα ἐστίν] imenski predikat (Smyth 909)
\item[ἀνέφηναν] §~267, §~234.a, §~238, 301.B (s. 118), §~460.1, §~454; glagol upotrijebljen kauzativno, „učiniti da što zasja''; objekt je ἄστρα, subjekt je neizrečen (οἱ θεοὶ); upitna čestica οὐκοῦν na početku ove rečenice otvara mjesto upravo ovomu predikatu οὐκοῦν\dots\ ἀνέφηναν „Nisu li (bogovi) učinili da zvijezde sjaje noću\dots''
\item[ἐμφανίζει] rekcija τινι τινα; §~231; kongruencija s množinom srednjega roda §~361
...
\begin{description}[noitemsep,topsep=0pt]
\item[ἔστι] §~315
\item[ἔστι ταῦτα] jedan od načina da se na grčkome kaže „da'', Smyth 2680
\item[ἔφη] §~312.8
\end{description}
...
\begin{description}[noitemsep,topsep=0pt]
\item[τὸ δ'] otvara mjesto sljedećemu pitanju; slobodnije „a što kažeš na ovo\dots?''
\item[δεόμεθα] rekcija τινος „trebati što'', §~243
...
\item[παρέχειν] §~231; dio akuzativa s infinitivom čiji je subjekt, kao i gore, neizrečeno \textgreek[variant=ancient]{τοὺς θεούς}
...
\item[πάνυ] „dakako''
\item[ἔφη] §~312.8, §~39.3, §~327.7, §~460.1, §~452
\item[φιλάνθρωπα] u imenskome predikatu izostavljena kopula (ἐστιν)
\end{description}
