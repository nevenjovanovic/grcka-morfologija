% <2021-12-26 ned> Unio ispravke NZ; pet, 12.12.2025. unio korekture AM; unio korekture NZ <2026-01-09 pet>
% \section*{O autoru}
...
Ksenofontovo djelo Κύρου παιδεία (\textit{Kirov odgoj}) nastalo je vjerojatno poslije 371.\ pr.~Kr. U osnovi je ono fiktivna, romansirana biografija perzijskoga vladara Kira Velikoga (oko 600. – 530.\ pr.~Kr.). Prikazujući Kirov život, Ksenofont ujedno prikazuje i svoje političke ideje. Utoliko djelo pripada i političkomu žanru πολιτεία (poput Platonove \textit{Države} ili djela Staroga Oligarha). Opisi perzijskih običaja i priča Ksenofonta pak povezuju s tradicijom etnografije onih koji su drugi, negrci (tu tradiciju predstavlja Herodot). 

Iz aspekta dugotrajnih grčkih ratova s Perzijancima mogli bi začuditi odabir teme i pohvalan ton djela. No, Grke Perzija zanima i fascinira odavno, a samoga Kira Velikoga, koji je vladao četrdesetak godina prije početka grčko-perzijskih sukoba, grčka književnost pozitivno prikazuje još od Eshila. 

\textit{Kirov odgoj} uzoran je primjer klasične atičke proze IV.~st.\ pr.~Kr. te se već u antici smatrao remek-djelom. Ponovno je otkriven u srednjemu vijeku kao jedan od uzora za književnu vrstu \textit{ogledalo vladara} (na primjer, za Machiavellijevo djelo \textit{Vladar}). 

Ovdje odabrani ulomak potječe iz prve knjige \textit{Kirova odgoja} i na vrlo općenit način govori o perzijskome obrazovnom sustavu opisujući odgoj dječaka do 16 odnosno 17 godina. Posebno se naglašava uloga starijih kao uzora te disciplina pri prehrani. Naglasak na usvajanju umjerenosti ili razumnoga pristupanja životu (σωφροσύνη) doziva u sjećanje etiku Ksenofontova učitelja Sokrata.
...
\item[εἰς τὸ μανθάνειν\dots\  αὐτοὺς] §~497, poimeničeni akuzativ s infinitivom, dopuna predikatu συμβάλλεται 
...
\item[διάγοντας] §~498, §~301.B (s.~116), §~238; glagol ἄγω i njegove složenice, poput διάγω, mogu imati i prijelazno i neprijelazno značenje; u ovome nam slučaju to pomaže odrediti dopuna, prilog σωφρόνως
\end{description}
...
\item[πρὶν ἂν ἀφῶσιν] zavisna vremenska rečenica, „dok ne\dots”, §~488.2, πρὶν s konjuktivom aorista označava općenitu vremenitost, vremensku radnju bez točno određenoga vremenskog referenta
...
\item[ὅταν\dots\ σημήνωσι] zavisna vremenska rečenica u značenju pogodbe eventualnoga oblika (ponavljanje u sadašnjosti), „kad god'' + prezent, §~488.2
...
\item[σῖτον μὲν\dots\ ὄψον δὲ\dots] \textbf{πιεῖν δέ\dots}\ koordinacija rečeničnih članova s pomoću čestica μέν\dots\ δέ\dots
\item[πιεῖν] §~231, §~327.16, §~490; infinitiv izriče svrhu% i ima objekt κώθωνα
\item[διψῇ] §~243, §~301.B (s.~116), 
\item[κώθωνα] objekt glagolskog oblika φέρονται kao i ἄρτον, κάρδαμον
...
\item[ὡς\dots\ ἀρύσασθαι] zavisna posljedična rečenica s veznikom ὡς, §~473, bilj.~2 (naumljena posljedica)
...
\item[τοξεύειν\dots\ ἀκοντίζειν] §~301.B (s.~116), §~490, infinitiv kao objektna dopuna glavnog glagola μανθάνουσι, §~493
...
\begin{description}[noitemsep]
\item[μέχρι μὲν\dots\ ἐκ τούτου δὲ\dots] koordinacija rečeničnih članova s pomoću čestica μέν\dots\ δέ\dots
...
\item[ἐξέρχονται] §~231, §~238, §~327.2, §~460.1, §~451; LSJ I.1.g
