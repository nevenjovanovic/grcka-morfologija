...
% Unio ispravke VR <2022-01-06 čet>; unesi korekture AM <2026-01-12 pon>; unesi ispravke VR NZ <2026-02-04 sri>

\section*{O tekstu}

Ulomak koji čitamo dio je Aristotelova spisa \textit{O pjesničkome umijeću} koji detaljno razmatra tragediju (6. – 22.\ poglavlje). Filozof najprije predstavlja tragediju i njezinih ključnih šest dijelova, a zatim objašnjava važnost njezina jedinstva ili cjelovitosti. Nakon toga izlaže neke uobičajene pogreške u shvaćanju pojma tragedije.
 
U ovome odlomku Aristotel na osnovi prethodnih određenja uspoređuje povjesničara i pjesnika. Razlika nije u formi, tj.\ između stiha i proze \textgreek[variant=ancient]{(ἔμμετρα λέγειν ἢ ἄμετρα):} stavimo li Herodotovu povijest u stihove, ona će i dalje ostati povijest. Metrička organizacija teksta samo je površinska odlika. Prema Aristotelu, pjesništvo se može baviti bilo čime, dok se povijest može baviti jedino onime što se dogodilo. Drugim riječima, pjesništvo je posvećeno općemu, a povijest pojedinačnomu.
...
\item[τῷ\dots\ λέγειν] §~231, poimeničeni infinitiv §~497
...
\item[τεθῆναι] §~311
\item[ἂν εἴη] §~315.2, subjekt je τὰ ῾Ηροδότου (sročnost sa subjektom u množini srednjega roda §~361); kopula otvara mjesto imenskomu dijelu imenskoga predikata%; ἄν + optativ, usp.\ gore
...
\item[λέγειν] infinitiv poimeničen članom τῷ 
\item[τὰ γενόμενα] §~254, poimeničeni particip §~499
\item[λέγειν] §~231
...
\item[τὰ καθόλου\dots\ τὰ καθ' ἕκαστον] poimeničenje članom §~373
\item[λέγει] §~231
\end{description}
...
\item[τῷ ποίῳ] sc.\ ἀνθρώπῳ „određenom čovjeku”
\item[τὰ ποῖ᾿ ἄττα] „određene stvari”; dvije upitne rečenice (jedna objašnjava općenito, druga pojedinačno znanje koje prenose pjesništvo, odnosno povijest) uvedene su upitnom korelativnom zamjenicom ποῖος u svezi s članom i neodređenom zamjenicom, LSJ ποῖος I.3 i I.4
...
\item[στοχάζεται ] rekcija τινος; §~231, „smjera, cilja, teži”
\item[ὀνόματα ἐπιτιθεμένη] §~305, složenica τίθημι; „dodavajući (svojim likovima tek naknadno) imena”; particip neki shvaćaju dopusno
\item[τὸ δὲ καθ' ἕκαστον] poimeničenje članom §~373; nakon subjekta neizrečena kopula ἐστιν (da se izbjegne ponavljanje); imenski dio predikata obje su upitne rečenice
...
\item[τοῦτο] tj.\ postupak naknadnog dodavanja imena %sc.\ τὸ καθόλου
\item[γέγονεν] §~272, kopulativni glagol otvara mjesto imenskoj dopuni, ovdje pridjevu
\item[συστήσαντες γὰρ τὸν μῦθον διὰ τῶν εἰκότων] „sastavivši priču na temelju vjerojatnih događaja”
...
\item[περὶ τὸν καθ' ἕκαστον] sc.\ ἄνθρωπον%; Aristotel misli na novu komediju, u kojoj autor izmišlja imena likova bez ikakva referiranja na stvarne osobe (za razliku od Aristofanove komedije)
\item[ποιοῦσιν] §~243
...
\item[τῶν γενομένων] §~254; poimeničeni particip §~499
...
\item[ἐστι] §~315.2, kopula imenskoga predikata otvara mjesto imenskoj dopuni, ovdje pridjevu 
\item[τὰ μὲν οὖν μὴ γενόμενα\dots] \textbf{τὰ δὲ γενόμενα\dots}\ koordinacija rečeničnih članova parom čestica
\item[τὰ\dots\ γενόμενα] §~254, poimeničeni particip §~499
\item[πιστεύομεν] §~231, \textit{verbum sentiendi} otvara mjesto A+I, odgovara hrvatskoj zavisnoj izričnoj rečenici
\item[εἶναι] §~315.2, kopula imenskoga predikata, otvara mjesto imenskoj dopuni
\item[φανερὸν] imenski dio imenskoga predikata, neizrečena je kopula ἐστίν
\item[ὅτι] izrični veznik uvodi zavisnu izričnu rečenicu
\item[δυνατά] sc. εἶναι (kopula je neizrečena), odgovara gornjemu \textgreek{εἶναι δυνατά}
\item[γὰρ] čestica uvodi objašnjenje: „naime\dots”
\item[ἂν ἐγένετο] §~254, apodoza (glavna rečenica) irealne pogodbene rečenice; sročnost sa subjektom u množini srednjeg roda §~361
\item[εἰ ἦν ἀδύνατα] pogodbeni veznik uvodi irealnu protazu (zavisna rečenica pogodbenoga perioda); sročnost sa subjektom u množini srednjeg roda kao gore
