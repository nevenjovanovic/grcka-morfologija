...
% Unio ispravke NZ <2021-12-30 čet>, unio korekture AM <2026-01-03 sub>; unesi ispravke NZ i VR <2026-01-15 čet>
%\section*{O autoru}
...
Λυσίας (Lizija, oko 445.\ – nakon 380.\ pr.~Kr.) djelovao je u Ateni kao \textgreek[variant=ancient]{λογογράφος}, profesionalni autor sudskih govora za druge; od nekoliko stotina njegovih govora sačuvano je tridesetak.

Oko 387.\ Liziju je angažirao nepoznati Atenjanin, sin tuženoga (ovaj je u međuvremenu preminuo) i šogor Aristofanov (\textgreek[variant=ancient]{Ἀριστοφάνης}; on nema veze s komičkim pjesnikom). Aristofan je, zajedno s ocem Nikofemom, iz nepoznatih razloga smaknut oko 390., a njihova je imovina (\textgreek[variant=ancient]{χρήματα}) u Ateni zaplijenjena. Međutim, vrijednost imetka bila je ispod onoga što je javnost očekivala (Aristofan i Nikofem bili su bliski dvojici vrlo uspješnih vojskovođa, Kononu i Euagori). Zato je Aristofanov tast, otac Lizijina klijenta (za kojega je govor napisan i koji je govor na sudu održao), optužen da je otuđio dio imovine u korist svoje kćeri i unuka. Optužba je tražila da Lizijin klijent državnoj riznici nadoknadi dio Aristofanove imovine koji je njegov otac navodno otuđio.
...
Odabrani je odlomak dio argumentacije (πίστεις), koja u govoru slijedi odmah nakon proslova (προοίμιον). Govornik dokazuje da nije vjerojatno (εἰκός) da je njegov otac posjedovao Aristofanovu imovinu, zato što ženidbena veza s Nikofemovom obitelji nije proizašla iz novčanih interesa, jednako kao što ni ostali brakovi u govornikovoj obitelji (oca s govornikovom majkom, govornikove druge sestre, govornika samoga) nisu sklapani radi financijske koristi.
...
Lys.\ 19.\ De bonis Aristophanis ad aerarium 14–17
...
\item[ἐκεῖνος] sc. govornikov
\item[γὰρ] čestica najavljuje iznošenje razloga ili objašnjenja, „naime''
\item[ὅτ´ ἦν ἐν τῇ ἡλικίᾳ] §~315; kopulativni glagol otvara mjesto nužnoj predikatnoj dopuni (imenski predikat, Smyth 910); ὅτε uvodi zavisnu vremensku rečenicu, §~487
...
\item[τὴν ἐμὴν\dots\ ὅτι δὲ\dots] koordinacija rečeničnih članova s pomoću čestice δέ
\item[ἐπιφερομένην] §~232%atributno
\item[ὅτι\dots\ ἦν θυγάτηρ] §~315; ὅτι uvodi zavisnu uzročnu rečenicu, §~468; kopulativni glagol otvara mjesto nužnoj predikatnoj dopuni (imenski predikat, Smyth 910)
...
\item[ἐθελόντων] §~231; participski dio genitiva apsolutnoga, §~504; kao kopulativni glagol otvara mjesto nužnoj dopuni u infinitivu
\item[λαβεῖν] §~231
\item[ἔδωκεν] §~306
\item[ὅτι ἐδόκουν] §~243; ὅτι uvodi zavisnu uzročnu rečenicu, §~468; \textit{verbum sentiendi} otvara mjesto nužnoj dopuni u infinitivu
\item[κάκιον γεγονέναι] „biti nižega roda”; §~272; §~325.11; komparativ priloga κακῶς; predikatni pridjev u srednjemu rodu jednine slaže se sa subjektom muškoga roda, §~365
\item[τὴν μὲν\dots\ τὴν δὲ\dots] koordinacija rečeničnih članova s pomoću čestica μέν\dots\ δέ\dots
\item[Φιλομήλῳ τῷ Παιανιεῖ] sc. ἔδωκεν
\item[βελτίω\dots\ εἶναι ἢ πλουσιώτερον] zbog izvanjskoga poravnavanja (kao i u latinskome) umjesto pozitiva iza ἢ stoji još jedan komparativ; §~315; kopulativni glagol otvara mjesto nužnoj predikatnoj dopuni (imenski predikat, Smyth 910); komparativi u korelaciji s pomoću rastavnog veznika ἤ, §~514.1.b
\item[ἡγοῦνται] §~243; \textit{verbum sentiendi} otvara mjesto akuzativu s infinitivom
\item[πένητι\dots\ ἀδελφιδῷ δὲ\dots] koordinacija rečeničnih članova s pomoću čestice δέ
...
\item[κᾆτ´] kraza καὶ εἶτα; nakon Fedrove smrti otac je kćer s istim mirazom dao Aristofanu
...
\item[ἐλάττω] akuzativ ženskoga roda; sc. προῖκα λαβεῖν
...
\item[ὅτι\dots\ χρησοίμην] s.\ 116; §~258; optativ u zavisnoj izričnoj rečenici iza sporednoga (historijskoga) vremena, §~467
\end{description}
...
\begin{description}[noitemsep,topsep=0.7pt]
\item[ἔχω] §~231
...
\item[ἡ ναυμαχία\dots\ ἐν Ἑλλησπόντῳ] pomorska bitka kod Egospotama (405.\ pr.~Kr.); Lisandar je iznenadio atensku flotu i kasnije smaknuo tri tisuće zarobljenih Atenjana
\end{description}
...
\begin{description}[noitemsep,topsep=0.7pt]
\item[αὐτός τε\dots\ τοῖν τε\dots\ τῷ τε\dots] koordinacija s pomoću enklitičnog sastavnog veznika, §~513.2
