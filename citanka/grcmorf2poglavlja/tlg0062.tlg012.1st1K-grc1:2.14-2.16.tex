...
% Unesi korekture AM <2026-01-14 sri>, unesi ispravke VR NZ <2026-02-13 pet>


\section*{O tekstu}

\textgreek[variant=ancient]{Ἀληϑῆ διηγήματα} (\textit{Istinite pripovijesti}) uz Lukijanova \textit{Ikaromenipa} jedan su od najranijih primjera žanra znanstvene fantastike; ujedno su možda i Lukijanovo najpoznatije djelo. Dvjema knjigama \textit{Istinitih pripovijesti} Lukijan parodira historiografe poput Ktezije iz Knida koji iznose neprovjerene (i neprovjerljive) informacije te fantastične priče. Čitamo o putovanju na Mjesec, boravku u kitovoj utrobi, posjetu otoku od sira te Otoku blaženih, kojim vlada mudri sudac podzemnoga svijeta Radamant. 
...
\item[τοὺς κατακειμένους] poimeničeni particip, složenica κεῖμαι, §~315.a
...
\item[τοῦ οἰνοχοεῖν] §~243; poimeničeni infinitiv §~373
...
\item[ἔστι δένδρα] sročnost sa subjektom u množini srednjega roda §~361
...
\item[καρπός ἐστι] imenski predikat, Smyth 909; sročnost sa subjektom u množini srednjega roda §~361
...
\begin{description}[noitemsep]
\item[ἐπειδὰν] uvodi zavisnu vremensku rečenicu u značenju pogodbene protaze (eventualnoga oblika, s konjunktivom) §~488.2
...
\item[γίνεται] §~232; jonski i helenistički oblik glagola γίγνομαι §~325.11; sročnost sa subjektom u množini srednjega roda §~361
...
\item[κατανίφει] kasniji oblik glagola κατανείφω, složenica glagola νείφω, preneseno značenje (LSJ κατανείφω A); sročnost sa subjektom u množini srednjega roda §~361
\item[ὑπερπετόμενα] ovaj particip, kao i gornji ἀνθολογοῦντα, dopuna su istoga subjekta \textgreek{τὰ μουσικὰ ὄρνεα}; §~232; složenica πέτομαι
\end{description}
...
\item[ᾄδεται] §~232, sročnost sa subjektom u množini srednjega roda §~361
\item[δὲ] označava nadovezivanje na prethodni navod
...
\item[ἐπειδὰν] uvodi zavisnu vremensku rečenicu u značenju pogodbene protaze (eventualnoga oblika, s konjunktivom) §~488.2
\item[δὲ] označava nadovezivanje na prethodni navod
\item[παύσωνται] §~267; παύομαι otvara mjesto predikatnom participu kao nužnoj dopuni: „prestajem što činiti”, §~501c
\item[ᾄδοντες] §~231
...
\item[ἡ μὲν γέλωτος, ἡ δὲ ἡδονῆς] sc.\ πηγαί; koordinacija rečeničnih članova s pomoću para čestica
\item[πίνουσιν] §~231
\item[τὸ λοιπὸν] poimeničenje svih vrsta riječi članom §~373; LSJ λοιπός 3
\item[ἡδόμενοι] §~232
\item[γελῶντες] §~243
\item[διάγουσιν] otvara mjesto predikatnomu participu kao nužnoj dopuni; §~231; prevodi se prilogom „neprestano”, a particip prevedite finitnim glagolskim oblikom
\end{description}
