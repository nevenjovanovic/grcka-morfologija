% dopune NJ, 27. 4. 2020.
% Unesi ispravke NZ <2022-01-02 ned>; unesi korekture AM <2026-01-06 uto>, unesi ispravke VR NZ <2026-01-22 čet>
...
Dio Cassius Historiae Romanae 62.16-17
...
\item[παίδων\dots] \textbf{γυναικῶν ἀνδρῶν γερόντων} subjektni genitiv, §~393.2; asindeton
...
\begin{description}[noitemsep]
\item[κἀν τούτῳ] priložna uporaba οὗτος, LSJ s.~v. VIII.6.b
...
\item[ἐσφάλλοντο] §~232; u doslovnome značenju, LSJ s.~v. A
...
\item[ἀνετρέποντο] složenica glagola \textgreek[variant=ancient]{τρέπω}, §~232, augment §~239
...
\begin{description}[noitemsep]
\item[συχνοὶ] potpumbeni predikat ili predikatni proširak (pridjev umjesto hrv. priloga) §~369; usp. LSJ συχνός A.II: „brojni''
...
\item[τῶν δυναμένων] poimeničeni particip, §~312.5, otvara mjesto dopuni u infinitivu; dijelni genitiv §~395
...
\begin{description}[noitemsep]
\item[οὐδὲ γὰρ οὐδ'] nadovezivanje na prethodnu rečenicu i uvođenje daljnjega objašnjenja, LSJ \textgreek[variant=ancient]{οὐδέ} C.II
...
\item[ἐδύναντο] §~312.5, glagol nepotpunoga značenja otvara mjesto dopuni u infinitivu
\item[κἂν] realna pogodbena rečenica §~475: „čak i ako\dots”
\item[τοῦ παρόντος] sc.\ κακοῦ; složenica glagola \textgreek[variant=ancient]{εἰμί,} §~315; poimeničeni particip; LSJ \textgreek[variant=ancient]{πάρειμι} II
...
\item[ἐν μιᾷ\dots\ ἐπὶ πλείους\dots] sc.\ \textgreek[variant=ancient]{ἡμέρᾳ καὶ νυκτί}
...
\begin{description}[noitemsep]
\item[πολλοὶ μὲν\dots\ πολλοὶ δὲ\dots] koordinacija česticama, izražava suprotnost
\item[τοῦ βοηθήσοντός] \textit{genetivus copiae et inopiae} uz \textgreek[variant=ancient]{ἔρημοι} §~403.2; poimeničeni particip §~243
\item[σφισιν] sc. οἴκοις
\item[ἀπώλοντο] §~319.15, §~254
\item[τῶν ἐπικουρούντων] poimeničeni particip, LSJ \textgreek[variant=ancient]{ἐπικουρέω} II
...
\item[οἱ γὰρ] čestica uvodi objašnjenje prethodnoga navoda
\item[ἀφορῶντες] „promišljajući, planirajući”; složenica glagola \textgreek[variant=ancient]{ὁράω} §~327.3, §~243, često otvara mjesto prijedložnom izrazu πρός τι 
\item[οὐχ ὅσον] LSJ \textgreek[variant=ancient]{ὅσος} IV.5.b; priložna uporaba \textgreek[variant=ancient]{ὅσον} uz negacije
...
\item[ὁρᾶν] akuzativ s infinitivom, subjektni je akuzativ πάντας δὲ τοὺς λοιποὺς ἑστῶτάς, objekti su νήσους τινὰς καὶ πόλεις ἅμα πολλὰς φλεγομένας; ovisno o \textgreek[variant=ancient]{ὥστε}; §~327.3, §~243
\item[φλεγομένας] §~232
...
\item[ἀναμιμνήσκεσθαι] akuzativ s infinitivom, subjektni je akuzativ ὀδυρομένους; složenica \textgreek[variant=ancient]{μιμνήσκω,} §~232; ovisno o \textgreek[variant=ancient]{ὥστε;} kao \textit{verbum sentiendi} otvara mjesto zavisnoj izričnoj rečenici
\item[ὅτι] veznik uvodi izričnu rečenicu, §~467
\item[καὶ πρότερόν ποτε] \textbf{ὑπὸ τῶν Γαλατῶν} autor aludira na galsko pustošenje Rima 390.\ pr.~Kr. pod vodstvom Brena, poglavice Senona, nakon poraza Rimljana kod rijeke Alije; jedini put da je strana vojska osvojila Rim u osam stoljeća (do vizigotskoga osvajanja 410.\ po~Kr.)
\item[τὸ πλεῖον] poimeničenje pridjeva članom §~373
\item[τῆς πόλεως] dijelni genitiv, §~395
