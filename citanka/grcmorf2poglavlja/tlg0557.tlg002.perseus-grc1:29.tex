...
% Unio korekture AM <2025-12-17 sri>; <2026-01-09 pet> unesi ispravke NZ

\section*{O tekstu}

Arijan iz Nikomedije \textgreek[variant=ancient]{(Φλάουιος Ἀρριανός,} Nikomedija u Bitiniji, oko 95. – Atena, oko 175.) priredio je u djelu \textgreek[variant=ancient]{Ἐγχειρίδιον} (\textit{Priručnik}) sažetak Epiktetovih učenja kao uvijek spreman vodič za filozofske susrete sa svakodnevicom. \textit{Priručnik} nije sustavna razrada etike, nego zbirka misli i uputa korisnih u konkretnim situacijama. Za razliku od dijaloškoga i argumentativnoga oblika djela \textgreek[variant=ancient]{Διατριβαί} (\textit{Dijatribe}), \textit{Priručnik} je apodiktičan, slobodan od metafizičkih i teoloških razmatranja. Pisan je fragmentarnim stilom, u kratkim odlomcima, uobličen u niz formula (vrlo su česti imperativi) i pamtljivih slika koje stoiku služe kao poticaji za dnevne meditacije.

Ovdje odabrani odlomak ističe važnost prethodnoga promišljanja; prije svakoga pothvata treba dobro procijeniti djelatnost u koju se upuštamo, ali i točno spoznati \textgreek[variant=ancient]{(καταμανθάνειν)} kakve su naše snage. Na životnome putu posebno je važna dosljednost \textgreek[variant=ancient]{(ἕνα ἄνθρωπον εἶναι)}; posvećivanje onomu izvanjskome ili unutarnjemu određuje hoće li tko biti \textgreek[variant=ancient]{φιλόσοφος} ili \textgreek[variant=ancient]{ἰδιώτης.}
...
\item[πρῶτον\dots\ εἶτα\dots] koordinacija rečeničnih članova s pomoću (vremenskih) priloga
\item[ἐπίσκεψαι] §~267; složenica glagola σκέπτομαι; \textit{verbum sentiendi} otvara mjesto zavisnoj upitnoj rečenici §~469
\item[ὁποῖόν ἐστι] §~315; kopulativni glagol otvara mjesto nužnoj predikatnoj dopuni (imenski predikat, Smyth 910)
\item[τὸ πρᾶγμα] sc.\ „biti filozof”
\item[κατάμαθε] §~254; složenica glagola μανθάνω, 321.17; \textit{verbum sentiendi} otvara mjesto zavisnoj upitnoj rečenici §~469
\item[εἰ δύνασαι] §~312.5; otvara mjesto dopuni u infinitivu
\item[βαστάσαι] §~267
\item[εἰ δύνασαι βαστάσαι] sc.\ αὐτήν „ako možeš nositi svoju prirodu”
\end{description}
...
\item[ἄλλος\dots\ πρὸς ἄλλο] hrv.\ „svatko za što drugo”
\item[πέφυκε] §~272
\end{description}
...
\item[ταῦτα ποιῶν] u ovome kontekstu: „baveći se filozofijom”
\item[ποιῶν] §~243
...
\item[μὴ] sc.\ ἴσθι
\item[ὡς] „kao”
\item[νῦν\dots\ ὕστερον δὲ] koordinacija rečeničnih članova s pomoću čestice δέ
\end{description}
...
\item[τὸ σαυτοῦ] poimeničena zamjenica, §~373; atribut uz τὸ ἡγεμονικόν
\item[τὸ ἐκτὸς] poimeničeni prilog, §~373; objekt infinitiva ἐξεργάζεσθαι
\item[περὶ τὰ ἔσω\dots\ περὶ τὰ ἔξω] poimeničeni prilog, §~373
