...
U ovoj basni, sačuvanoj pod imenom glasovitoga basnopisca Ezopa, razmatra se moć i neizbježnost sudbine.

Neki otac usne loš san o sinu jedincu. U strahu za njegov život poduzme sve kako se san ne bi nikada ostvario. No, brinući se prvenstveno za sinovu sigurnost, nije mislio na to je li sin i sretan. Osjećaj frustracije pokrenut će nesretan slijed događaja i tako će sin susresti svoju sudbinu premda pred nacrtanim lavom.
...
\item[μήπως ὁ ὄνειρος ἀληθεύσῃ] namjerna rečenica koja uvodi glagol bojazni, izriče bojazan da bi se što moglo dogoditi (umjesto μήπως uobičajeniji su veznici μή ili ὅπως μή)
\item[κατεσκεύασε] §~267, §~238, §~301.B (s. 118), §~460.1, §~454
\item[εἰσαγαγὼν] §~238, §~301.B (s. 116), §~498
\item[εἰσαγαγὼν τὸν υἱὸν] i \textbf{ἐφύλαττεν τὸν υἱὸν} oba glagola kao dopunu imaju isti izravni objekt pa se objekt ne ponavlja; u hrvatskom se objekt najčešće izriče: „uvevši sina, čuvao ga je”
\item[ἐφύλαττεν] §~231
\end{description}
...
\item[τοῦ βίου μετέστησεν] vidi LSJ μεθίστημι A.II
...
\item[τοῦ πατρὸς] genitivni atribut uz σοφίσματι
\item[ὠφεληθέντα] rekcija: τινι, „komu na korist u čemu”; §~296, §~243, §~235, §~498
\end{description}
...
\item[ὅτι\dots\ δύναται] glagol δηλοῖ otvara mjesto izričnomu vezniku ὅτι, koji uvodi izričnu rečenicu: „da…”
