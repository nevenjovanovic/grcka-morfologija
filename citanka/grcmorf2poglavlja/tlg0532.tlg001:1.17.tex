...
O popularnosti romana svjedoče egipatski papirusni fragmenti (najstariji je nalaz iz II.~st.). Djelo je poslužilo i kao glavni izvor bizantskomu autoru Eustatiju Makrembolitu (XII. st.) koji je prema \textit{Klitofontu i Leukipi} sastavio roman \textit{Priča o Hizmni i Hizminiji}.
...
\item[ἔλεγον] §~231; \textit{verbum dicendi} otvara mjesto obvezatnoj dopuni, ovdje A+I
