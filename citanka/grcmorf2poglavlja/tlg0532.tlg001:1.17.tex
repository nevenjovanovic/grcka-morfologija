% Unio ispravke NZ <2022-01-06 čet>; unesi ispravke NZ VR <2026-02-13 pet>

\section*{O autoru}

Ἀχιλλεὺς Τάτιος (Ahilej Tacije ili Tatije)iz Aleksandrije, iz II.~st.\ po Kr., autor grčkoga ljubavnog romana (uz Longa, Heliodora iz Emese, Haritona i Ksenofonta Efeškoga). Jedino su Tacijevo sačuvano djelo \textgreek{Τὰ κατὰ Λευκίππην καὶ Κλειτοφῶντα} (\textit{Zgode Leukipe i Klitofonta}).

Autor u prvome licu pripovijeda o ljubavi suočenoj s mnoštvom neprilika: brodoloma, otmica, susreta s piratima i razbojnicima. U tradiciji grčkoga ljubavnog romana ljubav na kraju pobjeđuje i sve sretno završava.
...
O popularnosti romana svjedoče egipatski papirusni fragmenti (najstariji je nalaz iz II.~st.). Djelo je poslužilo i kao glavni izvor bizantskomu autoru Eustatiju Makrembolitu (XII. st.) koji je prema \textit{Klitofontu i Leukipi} sastavio roman \textit{Priča o Hizmini i Hizminiji}.


\section*{O tekstu}

Neimenovani pripovjedač u prvome poglavlju romana opisuje sliku otmice Europe izloženu kao zavjetni dar u hramu božice Ištar. Pripovjedač ondje susreće mladića Klitofonta, koji mu priča o svojim pustolovinama koje potvrđuju moć prave ljubavi. Klitofont je bio zaručen za polusestru Kaligonu, ali se na prvi pogled zaljubio u svoju rođakinju Leukipu. Ona mu je uzvratila ljubav, a Kaligonu je oteo Kalisten, mladić iz Bizantija. No, Kalisten je u stvari htio oteti Leukipu, o čijoj se ljepoti nadaleko pričalo.

Klitofont i Leukipa odlučili su brodom pobjeći iz Tira, ali su u oluji doživjeli brodolom. Završili su u Egiptu, gdje su ih zarobili razbojnici s Nila. Klitofont je uspio pobjeći dok su Leukipu namjeravali žrtvovati. Misao da je Leukipa mrtva potakla je Klitofonta da se nakani ubiti na njezinu grobu. No, Leukipa je bila živa – njezino žrtvovanje bilo je varka Klitofontovih zarobljenih prijatelja.

Uskoro je egipatska vojska spasila družinu te se u Leukipu zaljubio egipatski general. Ona je popila ljubavni napitak namijenjen drugomu i skoro poludjela; spasio ju je protuotrov koji joj je dao stranac Hereja. Kad su već mislili da su spašeni i da se vraćaju u sigurnost Aleksandrije, Leukipu je oteo Hereja.
...
U odlomku iz prve knjige romana čitamo dio razgovora Klitofonta i njegova kućnoga roba Satira u prelijepome vrtu Klitofontove kuće. Leukipa šeće vrtom sa svojom robinjom, a Klitofont se nada da će ljubavna tema o kojoj govori i u Leukipi pobuditi ljubavne osjećaje.
...
\noindent τοσαύτην ἔχει τὴν ἰσχύν, \\
ὡς καὶ \\
...
\item[῏Η γὰρ] upitna čestica ἦ uvodi izravno pitanje; u pitanjima se može povezati s γάρ §~520.b
\item[ἔχει] §~231
...
\begin{description}[noitemsep]
\item[ἔφην] §~312.8, osnove §~327.7; Klitofont pripovijeda svoje doživljaje u prvome licu pa ovdje prepričava i svoj odgovor
...
\item[ἐγὼ δὲ δοκῶ μοι] čestica ovdje s ulogom suprotnoga veznika §~515.2
...
\item[κἂν ἴδῃ καὶ θίγῃ] sc. αὑτόν (τὸν σίδηρον); eventualna iterativna pogodbena rečenica (κἄν = ἐάν, ovdje gotovo ὁπόταν)  %veznička riječ κἄν uvodi zavisnu dopusnu rečenicu §~480
...
\item[ὥσπερ ἔχουσα] §~231; §~519.2; poredbeni prilog \textgreek[variant=ancient]{ὥσπερ} otvara mjesto neobvezatnoj dopuni u participu
...
\begin{description}[noitemsep]
\item[τι\dots\ φίλημα] „nekakav poljubac”
\item[ἐστιν] §~315.2; kopulativni glagol \textgreek[variant=ancient]{εἰμί,} kao dio imenskoga predikata, otvara mjesto dopuni, Smyth 909%me ti touto je sumnjivo
\item[ἐρώσης] §~243
\item[ἐρωμένου] §~243
\end{description}
...
\item[ἔλεγον ἂν] §~231; ἔλεγον u apodozi i ἔλεγον u protazi nemaju isti subjekt i nisu u istome licu i broju%\textit{verbum dicendi} otvara mjesto obvezatnoj dopuni, ovdje A+I
...
\item[εἰ μὴ καὶ\dots\ ἔλεγον] pogodbeni veznik εἰ μὴ καί uvodi zavisnu pogodbenu rečenicu irealnoga oblika za sadašnjost §~474
\item[ἔλεγον] §~231
\end{description}
...
\begin{description}[noitemsep]
\item[ὁ δὲ λόγος] čestica δέ ovdje u eksplanatornoj i narativnoj ulozi: „a\dots”
\item[λόγος] sc.\ ἐστίν
\item[ἐρᾶν] §~243, rekcija τινος, §~396.e; ovdje i dalje infinitivi ovise o izrazu ὁ\dots\ λόγος koji funkcionira kao \textit{verbum dicendi}; neupravni govor §~489
\item[ἄλλο φυτὸν ἐρᾶν] A+I
\item[ἐνοχλεῖν] §~243; rekcija τινι
\item[τῷ\dots\ φοίνικι] „stablu palme”
...
\item[δὲ] čestica δέ ovdje u narativnoj ulozi povezuje misao s prethodnom rečenicom
\item[τὸν μὲν\dots\ τὸν δὲ\dots] rečenični dijelovi koordiniraju se s pomoću čestica
\item[τὸν μὲν ἄρρενα\dots\ τὸν δὲ θῆλυν] akuzativi kao obvezatne dopune uz \textit{verbum dicendi}, infinitiv je neizrečen (kopula εἶναι)
...
\item[ἐρᾷ] §~243, rekcija τινος, §~396.e
\item[οὖν] čestica ovdje u ulozi potvrđivanja misli: „dakle\dots”
\item[κἂν ἀπῳκισμένος ᾖ\dots] veznička riječ κἄν uvodi zavisnu pogodbenu rečenicu eventualnoga oblika §~476
...
\item[τῇ τῆς φυτείας στάσει] „zbog položaja sadnje”
...
\item[εἰς τὴν τοῦ χωρίου περιωπὴν] \textgreek[variant=ancient]{περιωπή} je mjesto s kojega se može dobro osmatrati uokolo, zato je glagol \textgreek[variant=ancient]{ἀνέρχομαι} (mjesto je uzvišeno); LSJ \textgreek[variant=ancient]{περιωπή} A
...
\item[νένευκε] §~272
\item[κλίνεται] §~231
\item[γὰρ] čestica γάρ ovdje u eksplanatornome značenju: „jer naime\dots”
\item[τὸ ἐρώμενον] §~243, poimeničeni particip §~499
\end{description}
...
\begin{description}[noitemsep]
\item[ἀνέψυξε\dots\ ἀνεζωπύρησε\dots ἐξανέστη] niz gnomskih aorista, prevedi prezentom
