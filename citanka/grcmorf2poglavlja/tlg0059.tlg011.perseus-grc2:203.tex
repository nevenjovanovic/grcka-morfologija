...
% Unio ispravke NZ <2021-12-31 pet>, unio korekture AM <2026-01-03 sub>, unesi ispravke NZ VR <2026-01-15 čet>
%\section*{O autoru}
...
Odlomak je dio Sokratova govora o Erotu iz Platonova dijaloga \textgreek[variant=ancient]{Συμπόσιον} (\textit{Gozba}), djela nastaloga između 385.\ i 370.\ pr.~Kr. Dijalog, koji se odigrava na gozbi kod atenskoga tragičkog pjesnika Agatona nakon njegove pobjede na lenejama 416., razmatra pojam ljubavi \textgreek[variant=ancient]{(ἔρως).} Odavde potječe Sokratova pohvala Erotu, jedan od izvora renesansnoga pojma \textit{platonske ljubavi.}

U Platonovu prikazu Sokrat izlaže pretposljednji, poslije petorice sudionika gozbe. No, počinje tuđim riječima. Sokrat, naime, prepričava što je čuo i naučio od proročice Diotime iz Mantineje. Do susreta s Diotimom Sokrat je o ljubavi mislio poput svojih drugova s gozbe. Tako je proročica Sokratu ono što je on svojim učenicima.

Pohvala u ovome odlomku prikazuje Erotovo mitsko podrijetlo koje je odredilo i njegov karakter.
...
\item[γὰρ] čestica ovdje u eksplanatornoj ili emfatičkoj ulozi: „naime, baš”
...
\item[δὲ] čestica ovdje blago adverzativnoga značenja, u naraciji nastavlja razvijanje misli: „a…”
\item[προσαιτήσουσα] particip futura u namjernome značenju; §~258, sprezanje kao prezent §~259, tvorba futura kod \textit{verba vocalia} §~260 (glag.\ osnove §~301.B s.~116)
...
\item[ποιήσασθαι] §~267 (glag. osnove §~301.B s.~116); infinitiv je dopuna participu ἐπιβουλεύουσα, objekt je infinitiva παιδίον
...
\item[ἐραστὴς\dots\ περὶ τὸ καλὸν] „ljubitelj ljepote, ljubavnik onoga što je lijepo”
...
\item[πολλοῦ δεῖ ] fraza u rečenici ima adverbnu ulogu: „daleko od…”
\item[ἁπαλός… καλός] dijelovi imenskoga predikata
...
\item[ὢν] §~315
\item[σκληρὸς…] \textbf{\textgreek[variant=ancient]{αὐχμηρὸς… ἀνυπόδητος… ἄοικος… χαμαιπετὴς… ἄστρωτος}} imenske dopune uz particip ὢν, u ulozi imenskoga predikata
\item[ἐν ὁδοῖς] „uz putove” (liježe)
\item[κοιμώμενος] §~243 (glag. osnove §~301.B s.~116)
\item[ἔχων] §~231
\item[σύνοικος] glagolska dopuna nije izrečena, ἐστι ili ὢν; u ulozi imenskoga predikata
...
\item[τοῖς καλοῖς καὶ τοῖς ἀγαθοῖς] dativ srednjega roda (poopćeni izraz: „svemu što je\dots”)
\item[ὢν] §~315
\item[ἀνδρεῖος…] \textbf{\textgreek[variant=ancient]{ἴτης… σύντονος… θηρευτὴς}} imenske dopune participu ὢν u ulozi imenskoga predikata
\item[πλέκων] §~231
\item[ἐπιθυμητὴς… πόριμος] imenske dopune neizrečenomu finitnom ili participskom obliku glagola „biti” (ἐστι ili ὢν)
\item[φιλοσοφῶν] §~243
\item[δεινὸς… φαρμακεὺς… σοφιστής] imenske dopune neizrečenomu finitnom ili participskom obliku glagola „biti” (ἐστι ili ὢν)
\item[οὔτε… οὔτε] nezavisno složena sastavna rečenica: „niti… niti…”
\item[πέφυκεν] §~280, paradigma §~301.A s.~110
\item[ὡς ἀθάνατος… ὡς θνητός] pridjevska dopuna predikatu (kopulativnomu glagolu)
...
\item[θάλλει] §~231
\item[εὐπορήσῃ] §~267
\item[ὅταν εὐπορήσῃ] veznik ὅταν uvodi zavisnu vremensku rečenicu s nijansom eventualnoga pogodbenog značenja: „dok god…, kad god\dots”
\item[ἀποθνῄσκει] §~231
\item[ἀναβιώσκεται] §~231
\item[ποριζόμενον] §~231
\item[ὑπεκρεῖ] §~243
\item[ἀπορεῖ] §~243
\item[ὥστε… ἀπορεῖ… πλουτεῖ] veznik ὥστε uvodi posljedičnu rečenicu: „tako da…”
\item[πλουτεῖ] §~243
\item[ἐστίν] §~315
