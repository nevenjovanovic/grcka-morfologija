%\section*{O autoru}; unio korekture AM <2025-12-16 uto>; unesi ispravke NZ <2026-01-09 pet>
...
U odlomku koji čitamo kiklop Polifem pripovijeda ocu Posejdonu kako ga je oslijepio Odisej. Kiklop je na početku bio prilično samouvjeren: za njega je donijeti čitavo stablo iz planine tek sitnica, isto kao i obračunati se s nekolicinom Odisejevih drugova. No, ti bezveznjaci nadmudrili su ga s pomoću opojnoga sredstva i kolca.
...
\item[ἐστι] §~315; dio imenskoga predikata (Smyth 909)
...
\item[ἦν] §~315
\item[δίδωσί] §~305, §~311, §~460.1, §~451, povezuje dopunu πιεῖν
...
\item[ἐν ἐμαυτοῦ] prijedlog ἐν ne može otvarati mjesto genitivu; riječ je o eliptičnoj uporabi, izostavlja se riječ na koju se odnosi ἐμαυτοῦ: ἐν ἐμαυτοῦ οἰκίᾳ (εἶναι) „pri sebi (biti)”; LSJ ἐν A. I. 2. 
\item[ἤμην] §~315; kasniji oblik, čest kod Lukijana = ἦν
\item[κατεσπάσθην] §~299, §~301.B (s.~116), §~238, §~460.1, §~454
\item[καὶ… καὶ… δὲ] rečenice prvo ustrojene usporedno (καὶ… καὶ), nabrajanjem, završnu misao uvodi adverzativno δὲ: „i… i… a\dots”
...
\item[σοι] posvojni dativ (slobodnije: „imaš slijepog sina”)
