% Unio ispravke NZ <2022-01-01 sub>, unesi ispravke VR NZ <2026-01-22 čet> -- dopuni korekture AM <2026-01-22 čet>
\section*{O autoru}

\textgreek[variant=ancient]{Χαρίτων} (Hariton), autor ljubavnoga romana \textgreek[variant=ancient]{Τὰ περὶ Χαιρέαν καὶ Καλλιρόην} (\textit{Zgode Hereje i Kaliroje}), živio je najvjerojatnije između 50.\ pr.~Kr. i 50.\ po~Kr. Malo se zna o njemu osim onoga što je sam naveo na početku svojega romana: da je živio u maloazijskome gradu Afrodizijadi i da je bio tajnik retora Atenagore.

\section*{O tekstu}

Roman \textit{Zgode Hereje i Kaliroje} dugo se smatrao kronološki posljednjim grčkim ljubavnim romanom antike, ali su papirusni nalazi s jedne i jezična analiza s druge strane pokazali da je zapravo jedan od najranijih. U romanu susrećemo tipične žanrovske motive: ljubav dvoje iznimno lijepih, plemenitih i osjećajnih mladih ljudi, putovanja egzotičnim zemljama, gusare.

Glavni su junaci Hereja i Kaliroja, dvoje sicilskih Grka koji se zaljube na prvi pogled te se vrlo brzo i vjenčaju, no zavist drugih mladića koji su se borili za Kalirojinu ruku pokrene niz događaja zbog kojih Hereja mora krenuti u potragu za svojom dragom. Ta će ga potraga odvesti sve do Babilona, u kojemu će se za nju boriti na sudu, a potom će se istaknuti i kao sposoban vojskovođa u Egiptu. Za to vrijeme Kaliroja, oteta i prodana u roblje, za dobrobit svojega nerođenog djeteta (čiji je otac Hereja) sklapa brak s maloazijskim Grkom Dionizijem. 
...
\item[ἤρξαντο] §~269
\item[κολακεύειν] §~231; rekcija τινά „laskati komu”
...
\item[ἀλλὰ] čestica suprotnoga značenja: „ali\dots”
\item[καὶ τοὺς ἐνθάδε] sc.\ stanovnike ovoga mjesta
\item[νόμιζε] §~231
...
\item[οὖν] čestica zaključnoga značenja: „dakle\dots”
...
\item[ἤλειψάν] §~267, ἀλείφω; subjekt ovoga i svih daljnjih finitnih glagola jesu \textgreek{θεραπαινίδαι}
\item[ἀπέσμηξαν] ἀποσμήχω §~267
\item[ἀποδυσαμένης] §~267; genitiv apsolutni §~504 (ovdje bez nominalnoga dijela): „kad je svukla odjeću”
...
\item[τρυφερὰ δὲ σάρξ] u imenskome predikatu izostavljena je kopula
...
\item[καλὴ\dots\ καὶ περιβόητος] neizrečena je kopula imenskoga predikata
...
\item[ἦν] §~315
\item[τοῦ μέλλοντος] §~394; poimeničeni particip u značenju „budućnost''
...
\item[ἐνεδύσατο μὲν\dots\ κἀκεῖνο δὲ] koordinacija rečeničnih dijelova s pomoću para čestica
\item[τῶν ἐπιτυχόντων] τι otvara mjesto dijelnomu genitivu (ovdje u s.~r., „stvari koje su joj se našle pri ruci”) §~395
