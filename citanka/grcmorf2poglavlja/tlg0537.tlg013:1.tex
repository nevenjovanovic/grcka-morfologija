...
\textgreek[variant=ancient]{Κύριαι δόξαι,} \textit{Glavni nauci}, zbirka je četrdeset Epikurovih načela koju Diogen Laertije (možda nešto prije 250.\ po~Kr. uključuje u desetu knjigu svojeg enciklopedijskog djela \textgreek[variant=ancient]{Βίοι καὶ γνῶμαι τῶν ἐν φιλοσοφίᾳ εὐδοκιμησάντων} \textit{(Životopisi i misli znamenitih filozofa)}. Ta deseta, i posljednja, knjiga u cijelosti je posvećena Epikuru.
