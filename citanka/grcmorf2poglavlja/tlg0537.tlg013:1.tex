% Unesi ispravke NZ <2022-01-02 ned>; unesi korekture AM <2026-01-09 pet>, unesi ispravke NZ VR <2026-01-22 čet>

\section*{O tekstu}

\textgreek[variant=ancient]{Κύριαι δόξαι} (\textit{Glavni nauci}) zbirka je četrdeset Epikurovih načela koju Diogen Laertije, pišući možda nešto prije 250.\ po~Kr., uključuje u desetu i posljednju knjigu enciklopedijskoga djela \textgreek[variant=ancient]{Βίοι καὶ γνῶμαι τῶν ἐν φιλοσοφίᾳ εὐδοκιμησάντων} (\textit{Životopisi i misli znamenitih filozofa}). Ta knjiga u cijelosti je posvećena Epikuru.

Ovaj odlomak donosi prvih pet nauka; četiri od njih naknadno su sažeti još i u τετραφάρμακος („lijek od četiriju sastojaka”) nađen na jednome od papirusa iz Herkulaneja (pap.\ Herc.\ 1005, 4.9–14). Prvi se nauk, u rečenici unutar zagrada, poziva i na Epikurovu teoriju spoznaje, prema kojoj na ljudska osjetila (pa i na um) djeluju „sličice”, εἴδωλα, tanke opne koje predmeti odašilju. Peti nauk uči da nema života u ugodi bez razuma, ljepote i pravednosti, niti obratno.
...
\item[Τὸ μακάριον καὶ ἄφθαρτον] poimeničeni pridjevi, §~373
\item[οὔτε αὐτο\dots\ οὔτε ἄλλῳ\dots] koordinacija s pomoću para (niječnih) sastavnih veznika
\item[πράγματα ἔχει] LSJ πρᾶγμα III.5
\item[παρέχει] sc.\ πράγματα; §~231; složenica ἔχω
\item[ὥστε] veznik uvodi posljedičnu rečenicu
\item[ὥστε οὔτε ὀργαῖς οὔτε χάρισι συνέχεται] i srdžba i naklonost prema Epikuru obilježja su slabosti
...
\item[οὓς μὲν\dots\ οὓς δε\dots] sc.\ τοὺς θεοὺς; koordinacija surečenica s pomoću para čestica
...
\item[ἐπὶ τὸ αὐτὸ] „u istu tu točku, isto mjesto”
\item[ἀποτετελεσμένων] složenica τελέω; §~272
\item[ἀνθρωποειδεῖς] sc.\ τοὺς θεοὺς; pridjev je imenski dio predikata (izostavljena je kopula); „drugdje kaže da se bogovi mogu razaznati samo razumom, neki su brojem različiti, dok drugi jednolično proizlaze iz kontinuiranog priljeva sličnih slika usmjerenih na isto mjesto i u ljudskom obliku”
...
\item[τὸ\dots\ διαλυθὲν] §~296; složenica glagola λύω (osnove s.~108); poimeničeni particip, §~373
\item[τὸ γὰρ\dots\ τὸ δ'\dots] koordinacija rečeničnih članaka s pomoću čestice δέ; γὰρ: „naime\dots”
...
\item[τοῦ ἀλγοῦντος] §~243; poimeničeni particip, §~373
...
\item[τὸ ἡδόμενον] §~232; poimeničeni particip, §~373
...
\item[τὸ ἀλγοῦν] §~243; poimeničeni particip, §~373
\item[λυπούμενον] §~243; poimeničeni particip, §~373
\item[τὸ συναμφότερον] poimeničeni pridjev, §~373
...
\begin{description}[noitemsep]
\item[χρονίζει] §~231
\item[τὸ μὲν ἄκρον\dots\ τὸ δὲ μόνον ὑπερτεῖνον\dots] koordinacija rečeničnih članova s pomoću para čestica
...
\item[τὸ\dots\ ὑπερτεῖνον] §~231; složenica τείνω; poimeničenje participa članom §~373
\item[τὸ ἡδόμενον] §~232; poimeničenje participa članom §~373
...
\item[πλεονάζον] §~231, poveži s τὸ ἡδόμενον
\item[ἔχουσι] §~231
...
\begin{description}[noitemsep]
\item[Οὐκ ἔστιν] §~315; otvara mjesto infinitivu, LSJ εἰμί A.VI, ἔστι + infinitiv „biti moguće”
\item[ζῆν] §~243
\item[τοῦ φρονίμως\dots] \textbf{καὶ καλῶς καὶ δικαίως} sc.\ ζῆν (poimeničeni infinitiv §~497)
\item[ὑπάρχει] LSJ ὑπάρχω III, rekcija τινί
\item[οὐκ ἔστι] §~315; u egzistencijalnome značenju otvara mjesto A+I, LSJ εἰμί A.VI
