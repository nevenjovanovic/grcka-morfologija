% Unesi ispravke NZ <2022-01-06 čet>
% Unio ispravke VR <2022-01-06 čet>; unesi korekture AM <2026-01-13 uto>; unesi ispravke VR NZ <2026-02-13 pet>

\section*{O tekstu}

Na sredini treće knjige (Γ) \textit{Nikomahove etike} Aristotel s općih razmatranja o vrlini, volji i odgovornosti prelazi na razmatranje pojedinačnih vrlina. Pošto je govorio o hrabrosti, njezinim suprotnostima i njezinim pojavnim oblicima, prelazi na vrlinu umjerenosti \textgreek[variant=ancient]{(σωφροσύνη),} čija je suprotnost \textgreek[variant=ancient]{ἀκολασία.  Σωφροσύνη} je Aristotel definirao kao sredinu u odnosu prema užitcima \textgreek[variant=ancient]{(μεσότης ἐστὶ περὶ ἡδονὰς ἡ σωφροσύνη),} i to prvenstveno tjelesnima \textgreek[variant=ancient]{(σωματικαί).} Glavnina takvih užitaka nastaje po opipu, u jelu, piću, seksu: \textgreek[variant=ancient]{γίνεται πᾶσα δι᾽ ἁφῆς καὶ ἐν σιτίοις καὶ ἐν ποτοῖς καὶ τοῖς ἀφροδισίοις λεγομένοις.} Neumjereni pretjeruju na tri načina: uživaju u onome u čemu ne treba, ili više nego što treba, ili kako ne treba: \textgreek[variant=ancient]{ἢ τῷ χαίρειν οἷς μὴ δεῖ, ἢ τῷ μᾶλλον ἢ ὡς οἱ πολλοί, ἢ μὴ ὡς δεῖ.} No, onaj tko je neumjeren zbog svojih želja, doživljava i bol kad ne uspije ostvariti željeni užitak: \textgreek[variant=ancient]{ὁ μὲν ἀκόλαστος (λέγεται) τῷ λυπεῖσθαι μᾶλλον ἢ δεῖ ὅτι τῶν ἡδέων οὐ τυγχάνει.}

U sljedećemu odlomku Aristotel potanje opisuje patnje i želje onoga tko je neumjeren, govori o (neuobičajenome) izostanku užitka te potom o odnosu onoga tko je umjeren prema željama i užitcima.
...
\item[ὁ\dots\ ἀκόλαστος] antonim σώφρων, usp. LSJ ἀκόλαστος; poimeničenje članom svih vrsta riječi §~373
\item[μὲν οὖν]  kombinacija čestica označava prelaz i rezimiranje: „onda dakle\dots”
\item[ἐπιθυμεῖ] rekcija τινός; §~243
\item[τῶν ἡδέων] poimeničenje članom svih vrsta riječi §~373
...
\item[ταῦθ'] sc.\ τὰ ἡδέα %(Aristotel se koristi oblikom τὰ ἡδέα)
\item[λυπεῖται] §~243
...
\item[γὰρ] čestica upozorava na to da se navodi razlog: „naime\dots”%ima li gar... de?
\item[ἔοικε] §~327.b; ἔοικέ τινι LSJ ἔοικα III
\item[τὸ\dots\ λυπεῖσθαι] §~243; poimeničeni infinitiv §~497
\item[δ'] kopulativno δέ (izvan koordinacije s μέν) označava prijelaz iz rečenice u rečenicu; sljedeća rečenica iskazuje nešto novo ili drukčije, ali ne suprotno prethodnomu iskazu, Smyth 2386
...
\item[τὰ περὶ τὰς ἡδονὰς] poimeničenje svih vrsta riječi članom §~373
...
\item[διακρίνει] §~231; sročnost sa subjektom u množini srednjega roda §~361
\item[τοῖς μὲν\dots\ τοῖς δ' οὔ] koordinacija rečeničnih članova parom veznika%sc. χαίρει
\item[χαίρει] rekcija τινί uživati u čemu; §~231
\item[εἰ] uvodi pogodbenu rečenicu, ovdje je riječ o kombinaciji realnih protaza (ἐστιν ἡδὺ, διαφέρει) i potencijalne apodoze (πόρρω ἂν εἴη)
\item[δέ τῳ] nakon čestice slijedi dativ nenaglašenoga oblika neodređene zamjenice
...
\item[διαφέρει] LSJ s.~v. III.2 bezlično s dativom %rekcija τινός „od koga”; §~231
\item[μηδὲ διαφέρει ἕτερον ἑτέρου] „nije mu (τῳ) različito jedno od drugoga, ne razlikuje jednu stvar od druge”
...
\item[τοῦ ἄνθρωπος εἶναι] poimeničeni infinitiv §~497; §~315
\item[τέτευχε] §~272; rekcija τινός, LSJ τυγχάνω B.II.2
\item[τὸ μὴ πάνυ γίνεσθαι] poimeničeni infinitiv §~497; §~232; γίνομαι kao gore; uz infinitiv je negacija μή, πάνυ kao gore
...
\begin{description}[noitemsep]
\item[ὁ δὲ σώφρων] kopulativno δέ označava prijelaz iz rečenice u rečenicu; sljedeća rečenica iskazuje nešto novo ili drukčije, Smyth 2386; poimeničenje svih vrsta riječi članom §~373
\item[μέσως μὲν\dots\ ὅσα δὲ\dots] koordinacija rečeničnih članova parom čestica
\item[ἔχει] §~231; LSJ ἔχω B.II.2
\item[οὔτε γὰρ\dots\ οὐδ' ὅλως\dots\ οὐδὲ σφόδρα\dots] koordinacija s pomoću (niječnih) sastavnih veznika; γάρ uvodi objašnjenje prethodne tvrdnje: „naime\dots”
\item[ἥδεται οἷς\dots] rekcija τινί „u čemu”; §~232
\item[οἷς μάλιστα] sc.\ ἥδεται; zamjenica istodobno služi kao objekt predikata i uvodi relativnu rečenicu (na hrvatskome se antecedent mora izraziti: „u onome u čemu\dots”)
\item[δυσχεραίνει] §~231; rekcija τινί
\item[ὅλως] sc.\ ἥδεται
\item[οἷς μὴ δεῖ] uporaba relativa kao gore; δεῖ §~243, bezlično, otvara mjesto ovdje neizrečenoj dopuni u infinitivu (sc.\ ἥδεσθαι)
\item[ἀπόντων] složenica εἰμί, §~315; participski dio GA čiji je imenski dio neizrečen (ἡδέων)
\item[λυπεῖται] §~243
\item[ἐπιθυμεῖ] §~243
\item[ἢ] „osim možda''
\item[μετρίως] sc.\ ἐπιθυμεῖ, „njegova je žudnja umjerena”
\item[δεῖ] §~243, bezlično, otvara mjesto ovdje neizrečenoj dopuni u infinitivu (sc.\ ἐπιθυμεῖν)
...
\item[πρὸς ὑγίειάν ἐστιν] imenski predikat Smyth 909, sročnost sa subjektom u množini srednjega roda §~361
...
\begin{description}[noitemsep]
\item[ὁ γὰρ οὕτως ἔχων] sc.\ ἀκόλαστος; §~231; LSJ ἔχω B.II.2; poimeničenje participa članom §~499
\item[ἀγαπᾷ] §~243
