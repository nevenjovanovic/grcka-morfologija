% Unio ispravke NZ <2022-01-04 uto>, unesi korekture AM <2026-01-11 ned>, unesi ispravke VR NZ <2026-01-27 uto>

\section*{O tekstu}

Izokratov epideiktični govor \textgreek[variant=ancient]{Ἑλένης ἐγκώμιον} (\textit{Pohvala Helene}) nastao je oko 370.\ pr.~Kr.\footnote{Naziv „epideiktičan'' \textgreek[variant=ancient]{(ἐπιδεικτικός)} potječe iz Aristotelove klasifikacije, a danas označava raznolike oblike retoričke pohvale ili pokude osobe, grada, životinje ili stvari.}
...
Ovaj izvadak pripada pohvali Tezeju, najopsežnijemu dijelu govora. Tezej i Helena povezani su nešto manje poznatom pričom koja je znatno prethodila Trojanskomu ratu: htijući, kao Zeusov sin, za ženu uzeti neku Zeusovu kćer, Tezej je odlučio oteti i oženiti Helenu, tada još gotovo dijete. 

Poznato je da je Tezej oslobodio Atenu strahovita danka u krvi koji je grad plaćao kretskomu vladaru Minosu. Svakih sedam ili devet godina ždrijebom odabrani mladići i djevojke otplovili bi iz Atene na Kretu da budu žrtvovani Minotauru, čudovišnomu sinu Minosove žene Pazifaje i kretskoga bika. U doba trećega žrtvenog prinosa Tezej promatra tužni rastanak i odlučuje sam otići na Kretu, ubiti bika i osloboditi Atenu grozne obaveze. 
...
\item[τὸ τραφὲν] poimeničeni particip §~499, atributni položaj iza imenice §~375
\item[γενόμενον ] sc.\ τὸ τέρας; §~254 (osnove §~325.11)
\item[τῆς Ἡλίου θυγατρός] genitiv u atributnome položaju
\item[ᾧ] zamjenica otvara mjesto zavisnoj odnosnoj rečenici, antecedent je τὸ τέρας
\item[ἀποστελλούσης] §~231; dalji je objekt ᾧ
...
\item[ἡγήσατο] §~267, augment §~235; LSJ ἡγέομαι III.2; glagol otvara mjesto A+I u kojemu bi subjektni akuzativ bio infinitiv \textgreek{τεθνάναι;} pri prevođenju odaberite hrvatsku istovrijednicu koja će izreći \textit{svršenost} radnje
\item[εἶναι] §~315
\item[τεθνάναι] mješoviti perfekt §~317, §~317.2 (osnove §~234.8)
\item[ζῆν] §~243
\item[ἄρχων] rekcija τινός; §~231
\item[τῆς πόλεως τῆς\dots\ ἠναγκασμένης] jače istaknut atributni položaj §~375
...
\item[ἐχούσης] §~231
\item[προσήκει] §~231
\item[οἵαν προσήκει] odnosna zamjenica uvodi odnosnu rečenicu, njezin je antecedent ἰσχὺν
\item[συγκειμένην] rekcija ἔκ τινων; §~315.a; poimeničeni particip, §~499
...
\item[ἠλευθέρωσεν] rekcija τινά τινος „koga od čega”; §~267, augment §~235
\end{description}
