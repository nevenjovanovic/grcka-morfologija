% Unesi ispravke NZ <2022-01-03 pon>; unesi korekture AM <2026-01-09 pet>; unesi ispravke VR i NZ <2026-01-27 uto>



\section*{O tekstu}

Dijalog \textit{Ikaromenip} djelo je Lukijanove bogate mašte koje se koristi dvama omiljenim motivima: napada preuzetnost profesionalnih filozofa i opisuje istraživačko putovanje od Zemlje do drugih svjetova (kao npr. u djelima \textit{Haron, Menip, Istinita pripovijest}). U ovome dijalogu Menip, kinički filozof iz III.~st.\ pr.~Kr., odlazi put neba jer je to jedini način da dozna istinu budući da ono što nude filozofi na zemlji nema ni glavu ni rep. Sve što čuje oko sebe proturječne su teorije. Riječima njegova sugovornika: „Baš je čudno to što govoriš, da se ljudi, premda su mudri, međusobno spore oko svojih nauka i ne misle isto o istome.” 

Naslov djela aluzija je na priču o arhetipskome obrtniku Dedalu i njegovu sinu Ikaru. Dedal je obojici konstruirao krila da mogu odletjeti s Krete, međutim, Ikar je letio preblizu Suncu, koje je otopilo vosak na njegovim krilima, pa je pao u more i utopio se. Za Lukijana bi moglo biti važno da se Menip sigurno vratio na zemlju bez svojih krila.
...
\item[γε] §~519.1
\item[ἐπὶ] §~436.A
\item[οἵ\dots\ βεβηκότες ] poimeničeni particip §~373; §~321.6; §~272; smisao: „oni koji, kao prvo, hodaju po zemlji”
\item[τῶν\dots\ ἐρχομένων] poimeničeni particip §~373; §~232
\item[οἵ\dots\ ὑπερέχοντες] poimeničeni particip §~373; §~232; ὑπερέχω τινός „biti nadmoćan”
\item[τοῦ πλησίον] poimeničeni prilog „bližnji”; \textit{genetivus comparationis} uz \textgreek[variant=ancient]{ὀξύτερον} §~404
\item[δεδορκότες] §~272
...
\item[τοῖς ὑπὲρ τὴν σελήνην] \textgreek{τὰ ὑπὲρ τὴν σελήνην} „mjesta iza Mjeseca”; poimeničeni prijedložni izraz §~373
\item[ἐπεβάτευον] §~232; augment kod glagola složenih s prijedlogom §~238
\item[ἐκ τῶν ἀστέρων] §~424.a
\item[καταπεσόντες] složenica glagola πίπτω §~327.17; jaka aoristna osnova §~254; adverbni particip §~503
...
\begin{description}[noitemsep]
\item[εἰ τύχοι] „na primjer”; τυγχάνω §~321,19; jaka aoristna osnova §~254
...
\item[ὁπόσων εἴη πηχῶν] §~315.2; kosi optativ iza historijskoga vremena u upitnim rečenicama §~469
...
\item[δῆθεν] ironično, kao latinski \textit{scilicet} tobože, dakako, kako kažu”
