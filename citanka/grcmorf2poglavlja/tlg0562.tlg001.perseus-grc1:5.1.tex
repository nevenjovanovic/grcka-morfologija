% Unio ispravke NZ <2022-01-05 sri>; unesi korekture AM <2026-01-12 pon>; unesi ispravke NZ VR <2026-01-27 uto>; NAVODNICI

\section*{O tekstu}

Odlomak koji ovdje čitamo početak je pete od dvanaest knjiga djela \textgreek[variant=ancient]{Τὰ εἰς ἑαυτόν} (\textit{Razgovori sa samim sobom} ili \textit{Samom sebi}, poznato i kao \textit{Meditacije} ili \textit{Razmišljanja}); djelo je u posljednjemu desetljeću života sastavio rimski car i filozof Marko Aurelije Antonin (121. – 180.).

U dijaloškome obliku čovjeka se potiče da ne bude lijen i neumjeren. Priroda nam je sve odredila s mjerom – odmor, jelo, piće – i dala nam je narav da radimo ljudske stvari. Jedan od smislova ljudskoga postojanja jest u radu.
...
\item[ἔστω] §~315, kopula kao dio imenskoga predikata, imenski je dio πρόχειρον
...
\item[δυσκολαίνω] §~231
\item[εἰ πορεύομαι] veznik εἰ uvodi zavisnu pogodbenu rečenicu, ovdje realnoga oblika
\item[πορεύομαι] §~231, med. s rekcijom ἐπί τι LSJ πορεύω II.2
\item[τὸ ποιεῖν] §~243, poimeničeni infinitiv §~497
...
\begin{description}[noitemsep]
\item[ἥδιον] imenski dio imenskoga predikata, kopula je izostavljena, sc.\ ἥδιόν ἐστιν
\item[πρὸς\dots\ ἐνέργειαν; ] nezavisna upitna rečenica; pitanje se oblikuje intonacijom, a prepoznaje interpunkcijom
\item[τὸ ἥδεσθαι] §~231, poimeničeni infinitiv §~497
\item[γέγονας] §~272
...
\begin{description}[noitemsep]
\item[οὐ\dots\ κόσμον;] nezavisna upitna rečenica; pitanje se oblikuje intonacijom, a prepoznaje interpunkcijom
\item[βλέπεις] §~231
\item[ποιούσας] §~243
...
\begin{description}[noitemsep]
\item[ἔπειτα] izražava iznenađenje, prijezir: „onda\dots”; LSJ s.~v.\ II.
\item[θέλεις] §~231, otvara mjesto dopuni u infinitivu
\item[ποιεῖν] §~243
\item[τρέχεις] §~231
\item[τὸ κατὰ τὴν σὴν φύσιν] poimeničeni prijedložni izraz „ono što je u skladu s tvojom prirodom, tvoje prirodno određenje”
...
\item[ἔδωκε] §~306
\item[τοῦ ἐσθίειν καὶ πίνειν] sc.\ μέτρα; poimeničeni infinitivi §~497
\item[ἐσθίειν] §~231
\item[πίνειν] §~231
\item[τὰ ἀρκοῦντα ] §~243, poimeničeni particip §~499
...
\begin{description}[noitemsep]
\item[φιλεῖς] §~243
\item[τοι] čestica τοι često se u uporabi izjednačava s (etičkim) dativom osobne zamjenice σύ; u tekstu implicira prisutnost sugovornika, zbog čega se često upotrebljava u dijalozima („kažem ti, vidiš, znaš”)
\item[ἐπεί\dots\ ἄν\dots\ ἐφίλεις] veznik ἐπεί uvodi zavisnu uzročnu rečenicu; ἄν s indikativom prošloga vremena izriče irealnost, Smyth 2243: „jer bi\dots, inače bi\dots”
\item[ἐφίλεις] §~243
