% Unesi ispravke NZ <2022-01-04 uto>; unesi korekture AM <2026-01-11 ned>; unesi ispravke VR NZ <2026-01-27 uto>


\section*{O tekstu}

Djelo \textgreek[variant=ancient]{Τὰ εἰς ἑαυτὸν} (\textit{Razgovori sa samim sobom} ili \textit{Samom sebi}),  dvanaest knjiga filozofskih zapisa (poznato i kao \textit{Meditacije} ili \textit{Razmišljanja}) nastalo je u posljednjemu desetljeću života rimskoga cara, između 170.\ i 180.\ po~Kr. Marko Aurelije grčkim se jezikom, koji je usvojio još u djetinjstvu, služi kao jezikom privatnosti i meditiranja nasuprot latinskoga, jezika službe i formalnih dužnosničkih zadaća. Ovaj je njegov „duhovni dnevnik'', jedno od moralno najuzvišenijih djela antike, i dokument kulturne i duhovne klime II.~st.\ po~Kr. – svjedoči o nesigurnosti, krhkosti, usamljenosti i izgubljenosti u svijetu tuđemu individualnoj prirodi. Djelo se suprotstavlja glavnoj struji tadašnje književne produkcije, elegantnoj, ali ispraznoj: romanima, govorima, retoričkim ekshibicijama.

Sljedeće razmišljanje iz četvrte knjige blisko je Epiktetovoj misli da nesreću treba pretvoriti u prednost; umjesto da se žalimo na svoj udes, razmotrimo koliko smo sretni što (zahvaljujući stoičkomu učenju koje smo usvojili) nesreću možemo nadići.
...
\item[προσρήσσεται] §~232; sročnost sa subjektom u množini srednjega roda §~361
...
\item[οὔτε ὑπὸ παρόντος\dots] \textbf{οὔτε ἐπιὸν\dots}\ koordinacija rečeničnih članova s pomoću (niječnih) sastavnih veznika
\item[παρόντος] složenica εἰμί, §~315; LSJ πάρειμι II, poimeničeno: „sadašnjost”
\item[θραυόμενος] §~232
\item[ἐπιὸν] složenica εἶμι §~314.1; LSJ ἔπειμι (B) II, poimeničeno: „budućnost” (paralela s \textgreek[variant=ancient]{παρόντος)}
\item[φοβούμενος] §~243
...
\begin{description}[noitemsep,topsep=0.5em]
\item[συμβῆναι μὲν\dots\ ἄλυπος δὲ\dots] koordinacija rečeničnih članova s pomoću para čestica
...
\item[ἀπότευγμα τῆς φύσεως τοῦ ἀνθρώπου] „neuspjeh, otklon od čovjekove prirode”
...
\item[παρὰ τὸ βούλημα τῆς φύσεως αὐτοῦ] „mimo volje njegove prirode”
...
\item[μήτι] u izravnome pitanju, očekuje se odgovor „ne'': „ne sprečava te onda\dots?”
...
\item[μεγαλόψυχον] sc.\ εἶναι (tako i ostali pridjevi u ovome nizu); imenski predikat, Smyth 909
...
\item[ἀπέχει τὰ ἴδια] „dolazi na svoje”
\end{description}
...
\item[οὐχ ὅτι\dots\ ἀλλὰ] koordinacija s pomoću suprotnog veznika
\item[ἀτύχημα] imenski dio predikata, sc.\ ἐστι
\item[τὸ φέρειν] poimeničeni infinitiv, §~497
