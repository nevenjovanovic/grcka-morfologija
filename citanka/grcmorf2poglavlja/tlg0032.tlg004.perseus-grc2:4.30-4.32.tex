% Dovršio NJ <2022-01-07 pet>, unesi ispravke VR NZ <2026-02-13 pet>


\section*{O tekstu}

\textgreek[variant=ancient]{Συμπόσιον} (\textit{Gozba} ili \textit{Pijanka}) Atenjanina Ksenofonta (oko 430.\ – 355.\ pr.~Kr.) žanrovski pripada tzv.\ sokratičkim dijalozima. Uz Platonovo djelo i nekoliko fragmenata Eshina iz atičke deme Sfeta \textgreek[variant=ancient]{(Αἰσχίνης Σφήττιος),} ti su dijalozi sve što danas imamo od nekoć brojnih spisa posvećenih atenskomu mudracu. 

S djelima \textgreek[variant=ancient]{Ἀπολογία Σωκράτους} (\textit{Sokratova obrana}) i \textgreek[variant=ancient]{Ἀπομνημονεύματα Σωκράτους} (\textit{Uspomene na Sokrata}), \textit{Gozba} tvori Ksenofontovu sokratičku trijadu. Gozbu iz naslova atenski bogataš Kalija priredio je u čast pobjede svojega ljubavnika Autolika na panatenejama 422.\ pr.~Kr. u pankratiju \textgreek[variant=ancient]{(παγκράτιον,} šakanje i hrvanje). Ksenofont prikazuje slavlje s muzičarima, akrobatskim plesačima i mimom (na samome kraju djela plesna skupina mimički prikazuje kako su Dioniz i Arijadna proveli ljubavnu noć, što nam pruža rijetko svjedočanstvo o izvedbama mima prije helenizma). Prikaz je vjerojatno nastao nakon Platonove \textit{Gozbe}. Ksenofontov Sokrat drži dug govor posvećen homoseksualnoj ljubavi. Pritom strogo razlikuje ljubav koja teži fizičkomu zadovoljenju, osuđujući je kao odvratnu i beskorisnu, od plemenite ljubavi u kojoj se ljubavnik trsi ohrabriti ono najbolje u svojemu voljenome pokazujući tako da zaslužuje mladićevo divljenje. Takvu su dihotomiju sigurno odobravali brojni Ksenofontovi suvremenici iako Platon, kao kudikamo bolji psiholog, u \textit{Fedru} (253e–263e) pokazuje da obje vrste ljubavi mogu supostojati u istoj osobi. 

U odabranome odlomku Harmid odgovara zašto se toliko ponosi svojim siromaštvom; pitanje „\textgreek[variant=ancient]{δι᾿ ὅ τι ἐπὶ πενίᾳ μέγα φρονεῖς;}” postavio mu je domaćin Kalija. Ostavši bez imetka, bivši bogataš Harmid postao je slobodan čovjek koji živi na teret države. Imućni mu podilaze gledajući u njemu mogućega birača i porotnika. Ne treba više strahovati za vlastitu i sigurnost svoje imovine i ne mora imati posla s ucjenjivačima. Oslobođen brige za svoju imovinu i lišen svih nameta napokon mirno spava. Ne može ništa izgubiti jer nema što izgubiti; naprotiv, može samo dobiti.
...
\item[πλούσιος ἦν] §~315; pridjevska dopuna kopulativnomu glagolu (imenski predikat), Smyth 910
\item[πρῶτον μὲν\dots\ ἔπειτα δὲ\dots] koordinacija rečeničnih članova s pomoću čestica μέν\dots\ δέ\dots\ i nabrajanja
...
\item[αὐτόν\dots\ με] „meni samomu”
\item[τί\dots\ κακὸν] neodređenu zamjenicu dopunjava atribut 
\item[ἐργάσαιτο] ἐργάζομαί τινά τι „komu što učiniti”; slabi aorist §~267
\item[τοὺς συκοφάντας] συκοφάντης je u atičkome pravu privatna osoba, građanin koji samoinicijativno prijavljuje nadležnim službama počinitelje prekršaja. Djelatnost se kod nekih gotovo pretvarala u profesiju, podložnu zlouporabama (pobijedi li u procesu, sikofant je ostvarivao dobit).
\item[ἐθεράπευον] §~231
\item[εἰδὼς] §~317.4
...
\item[ὅτι\dots\ ἱκανὸς εἴην] particip εἰδὼς (\textit{verbum sentiendi)} otvara mjesto vezniku ὅτι i izričnoj rečenici; optativ u zavisnoj rečenici stoji obično iza historijskih vremena u glavnoj; §~315; pridjevska dopuna kopulativnomu glagolu (imenski predikat), Smyth 910
...
\item[γὰρ] §~517
\item[προσετάττετο] glagol otvara mjesto infinitivu; pasivno značenje (vršitelj radnje izrečen prijedložnim izrazom s ὑπό); §~232
...
\item[τὰ ἔγγεια] τὰ ἔγγεια ili ἔγγαια „tuzemni posjedi” (u Atici)
\item[οὐ καρποῦμαι] §~243; „ne ostvarujem dobit”
...
\item[πιστὸς\dots\ γεγένημαι] „stekao sam povjerenje”; §~325.11; perfekt §~272; kopulativno γίγνομαι Smyth 917; πιστός τινι pridjev ima pasivno značenje (ne „onaj koji je vjeran komu”, nego „onaj u koga drugi imaju povjerenje”)
...
\item[τε\dots\ καὶ\dots\ καὶ\dots] „ne samo\dots\ nego i\dots” §~513.2 
\item[ἔξεστί μοι] §~315, bilj. 2
\item[ἀποδημεῖν\dots\ ἐπιδημεῖν] §~243; infinitiv kao subjekt uz bezlične izraze §~492
\item[ὑπανίστανται\dots\ ἐξίστανται] složenice glagola ἵστημι; §~305; §~311.2; značenje medija §~448.1; Harmid možda ovdje sebe zamišlja kao potencijalnoga birača ili porotnika
\item[θάκων\dots\ ὁδῶν] §~402 \textit{genetivus separationis}
\item[οἱ πλούσιοι] poimeničeni pridjev §~373
\end{description}
...
\begin{description}[noitemsep]
\item[νῦν μέν\dots\ τότε δὲ\dots] koordinacija rečeničnih članova s pomoću čestica μέν\dots\ δέ\dots\ (i vremenskih priloga)
...
\item[τότε μέν ... νῦν δὲ] koordinacija rečeničnih članova s pomoću čestica μέν\dots\ δέ\dots\ (i vremenskih priloga, kao gore; paralelizam ima i stilsku vrijednost)
...
\begin{description}[noitemsep]
\item[ὅτε μὲν\dots\ νῦν δ'\dots] koordinacija rečeničnih članova s pomoću čestica μέν\dots\ δέ\dots
...
\item[ὅτε μέν γε\dots\ νῦν δέ\dots] koordinacija rečeničnih članova s pomoću čestica μέν\dots\ δέ\dots; postponirano γε §~519.1
