...
Povjesničar \textgreek[variant=ancient]{Δίων ὁ Κάσσιος} (Dion Kasije, latinski \textit{Lucius Cassius Dio}; navodni njegov \textit{cognomen Cocceianus}, Kokcejan, spominje se tek u bizantsko doba i vjerojatno je fiktivan), podrijetlom Grk iz Nikeje u Bitiniji, rođen je oko 155.\ po~Kr., a umro oko 235. Vršio je službu konzula i prokonzula.
...
Dio Cassius Historiae Romanae 62.16.1-4
...
\item[ἐν παντὶ ἀπορίας γενέσθαι] „doći u stanje krajnje bespomoćnosti''
\item[γενέσθαι] §~254, §~325.11
...
\item[πολλὰ μὲν\dots\ πολλὰ δὲ\dots] koordinacija rečeničnih članova s pomoću para čestica
...
\begin{description}[noitemsep]
\item[οὔτε\dots\ οὔτε\dots] koordinacija s pomoću sastavnih veznika §~513
\item[θεάσασθαι] §~267
...
\item[οἱ μὲν τῇ, οἱ δὲ τῇ] koordinacija s pomoću čestica: „jedni ovamo, a drugi onamo”
...
\item[τὰ οἴκοι καιόμενα] §~232; poimeničeni particip, §~373; prilog u atributnome položaju §~375.5
...
\item[τῶν σφετέρων] dijelni genitiv §~395; poimeničena zamjenica, §~373; τὰ σφέτερα „njihova svojina”
...
\item[οἵ\dots\ ἐκ τῶν οἰκιῶν] poimeničeni prijedložni izraz
...
\item[αὐταῖς] sc. ταῖς οἰκίαις
\item[βοηθήσοντες] rekcija τινί, §~259
\item[οἱ ἐκ τῶν ὁδῶν] poimeničeni prijedložni izraz
