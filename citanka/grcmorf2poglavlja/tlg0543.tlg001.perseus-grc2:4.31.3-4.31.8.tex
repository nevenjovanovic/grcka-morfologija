% Unio ispravke NZ <2022-01-01 sub>; unesi korekture AM <2026-01-05 pon>, unesi ispravke VR NZ <2026-01-22 čet>


\section*{O tekstu}

U četvrtoj knjizi svojih \textgreek[variant=ancient]{Ἱστορίαι} (\textit{Povijesti}) Polibije pripovijeda o grčkome Savezničkom ili Etolskom ratu. Rat je protiv Etolskoga saveza, Sparte i Elide vodio Ahajski savez predvođen Filipom V.\ Makedonskim, od 220.\ do 217.\ pr.~Kr.
...
\item[φοβερὸν μὲν\dots] \textbf{οὐ μὴν οὕτω γε φοβερὸν\dots}\ adverzativna uporaba kombinacija čestica; μὴν odgovara na tvrdnju uvedenu s μὲν (γε „baš”): „\dots\ ali ipak ne baš\dots”
...
\item[ὑπομένειν] §~231; infinitiv kao predikat zavisne posljedične rečenice, kao subjekt akuzativa s infinitivom zamislimo τινα ili ἡμᾶς da bi se dobio smisao „treba podnositi''; LSJ ὑπομένω II.2
\item[χάριν] prilog, rekcija τινός, LSJ χάρις A.VI.1.
\item[τοῦ μὴ προσδέξασθαι] poimeničeni infinitiv (ovdje zanijekan), §~373
...
\item[τῆς εἰρήνης] \textit{genetivus comparationis}
\end{description}
...
\begin{description}[noitemsep]
\item[ἐπαινοῦμεν] §~243
\item[τὰ Μηδικά] poimeničeni pridjev, §~373; ovdje u specifičnome značenju „Perzijski ratovi''
...
\item[τὰ Περσῶν] poimeničeni geniti vposvojni, §~373; ovdje u specifičnome značenju „strana Perzijanaca''
\item[εἵλοντο] §~254, §~327.1
\item[συναποφηνάμενον] §~254; složenica φαίνω, s. 118; rekcija τινί + infinitiv, \textgreek[variant=ancient]{τὸν συναποφηνάμενον αὐτοῖς ἄγειν τὴν ἡσυχίαν} „koji se slagao s njima tvrdeći da treba živjeti u miru”
\item[ἄγειν] §~231; ovomu je infinitivu mjesto otvorio oblik συναποφηνάμενον
\item[τῶν ποιημάτων] LSJ ποίημα, ατος, τό, (ποιέω) I.2 u pluralu o pojedinačnim stihovima, u značenju ἔπη
\item[τὸ κοινόν τις ἀστῶν\dots\ τὸ φαιδρὸν φάος] ovo je Pindarov ulomak 109 iz ode Tebancima, sačuvan također i u \textit{Izvadcima} Ivana Stobeja \textgreek[variant=ancient]{(Ἰωάννης ὁ Στοβαῖος)} iz V. st. po~Kr.\ (Stob. ecl. 4.16.6); moguće je da oda i ne govori o događajima iz Grčko-perzijskoga rata 480.
\item[τὸ κοινόν] poimeničeni pridjev, §~373
\item[τιθεὶς] §~305
...
\begin{description}[noitemsep]
\item[δόξας] §~267, §~325.2; \textit{verbum sentiendi} otvara mjesto dopuni u infinitivu; subjekt participa δόξας i πεποιημένος jest Pindar
\item[εἰρηκέναι] §~272, §~327.7
\item[μετ´ οὐ πολὺ] = οὐ πολὺ μετά u vremenskome značenju
...
\item[τοῦ δικαίου καὶ πρέποντος] poimeničeni pridjevi, §~373
\item[κάλλιστόν ἐστι κτῆμα καὶ λυσιτελέστατον] §~315; imenski predikat, Smyth 910
\item[αἴσχιστον καὶ βλαβερώτατον] sc.\ ἐστι; imenski dijelovi imenskoga predikata, Smyth 910
