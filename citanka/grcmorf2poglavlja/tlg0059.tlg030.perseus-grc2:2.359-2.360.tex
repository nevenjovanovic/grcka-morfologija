% Unesi ispravke NZ <2022-01-02 ned>; unesi korekture AM <2026-01-07 sri>, unesi ispravke VR NZ <2026-01-22 čet>

\section*{O tekstu}

Πολιτεία (\textit{Država}) Platonov je dijalog u deset knjiga nastao oko 380. Krećući od jednostavnoga pitanja „je li uvijek bolje biti pravedan nego nepravedan?'', djelo se bavi temama pravednosti (δικαιοσύνη), poretka u pravičnome gradu državi, i pravednoga čovjeka, ali i problemima pjesništva. \textit{Država} je jedno od najpoznatijih i najutjecajnijih Platonovih djela.

U drugoj knjizi dijaloga, Glaukon Platonov brat i jedan od sudionika razgovora, govori o pretku lidijskoga kralja Giga, pastiru koji je našao čudesni prsten i s pomoću njega postao kralj. Glaukon se mitom koristi da bi Sokratu postavio pitanje može li čovjek biti dovoljno valjan da odoli iskušenjima čak i kad se ne mora bojati da će ga itko otkriti.
...
\item[εἶναι] §~315
\item[θητεύοντα] §~231
\item[εἶναι\dots\ αὐτὸν ποιμένα θητεύοντα] §~491, A+I ovisi o glagolu govorenja iz prethodne rečenice, kao i svi sljedeći infinitivi u tekstu ako nije drukčije naznačeno; εἶναι se može prevesti prošlim nesvršenim vremenom; imenski predikat, Smyth 910
\item[τότε] prilog u službi atributa i u atributnome položaju
...
\item[ῥαγῆναί τι] §~491
\item[τῆς γῆς] dijelni genitiv ovisan o τι §~395
...
\item[ἰδεῖν] §~327.3
\item[ἄλλα τε\dots\ καὶ ἵππον\dots] koordinacija s pomoću para sastavnih veznika, pri čemu je drugi član jače istaknut
...
\item[ἐγκύψαντα] subjekt A+I uz ἰδεῖν (ovisno o udaljenome \textit{verbum dicendi}); složenica κύπτω, §~267
\item[ἰδεῖν] §~327.3
...
\item[τὰ περὶ τὰ ποίμνια] poimeničeni prijedložni izraz
...
\item[τυχεῖν] §~321.19, §~254; otvara mjesto predikatnomu participu περιαγαγόντα §~501.b
...
\item[γενέσθαι] §~325.11, u ulozi kopule, s pridjevom kao predikatnom dopunom, Smyth 917
\item[ἀφανῆ αὐτὸν γενέσθαι] §~491
\item[τοῖς παρακαθημένοις] složenica κάθημαι, §~315.4, poimeničeni particip; ovisan o ἀφανῆ
\item[διαλέγεσθαι] sc.\ αὐτούς (παρακαθημένους); složenica λέγω, §~232, §~491
\item[οἰχομένου] sc.\ τοῦ ποιμένος §~232
\end{description}
...
\item[φανερὸν γενέσθαι] γίγνεσθαι ima ulogu kopule, s pridjevom kao predikatnom dopunom, Smyth 917
...
\item[στρέφοντι] §~231
\item[γίγνεσθαι] §~325.11, §~232; ima ulogu kopule, s pridjevom kao predikatnom dopunom, Smyth 917
...
\item[τῶν ἀγγέλων] dijelni genitiv uz kopulativni glagol, §~396.2: „jedan od\dots”
\item[γενέσθαι] §~325.11, LSJ γίγνομαι II.3.a
\item[τῶν παρὰ τὸν βασιλέα] atribut uz τῶν ἀγγέλων, u atributivnome položaju
\item[ἐλθόντα] §~327.2
\item[δὲ] označava nadovezivanje na prethodni navod 
\item[αὐτοῦ] posvojni genitiv §~393.2
\item[μοιχεύσαντα] rekcija τινά, §~267
\item[μετ' ἐκείνης] LSJ μετά A.II „zajedno s, uz, s pomoću” (implicira vezu tješnju nego σύν)
