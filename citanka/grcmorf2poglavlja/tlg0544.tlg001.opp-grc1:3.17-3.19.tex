% Unio ispravke NZ <2022-01-05 sri>, unesi korekture AM <2026-01-13 uto>, unesi ispravke NZ VR <2026-02-04 sri>

\section*{O autoru}

Σέξτος ὁ Ἐμπειρικός (Sekst Empirik, latinski \textit{Sextus Empiricus}) bio je grčki filozof, astronom i liječnik (nadimak Ἐμπειρικός dobio je po pripadnosti istoimenoj medicinskoj školi) iz II.~st. po Kr. Živio je u Rimu, Ateni i Aleksandriji. Pripadao je filozofskoj školi skepticizma, zapravo neoskepticizma, koju je utemeljio \textgreek[variant=ancient]{Πύρρων} (Piron iz Elide, IV. – III.~st. pr.~Kr.). 
...
Sustav je opširno prikazao u spisu \textgreek[variant=ancient]{Πρὸς μαϑηματικούς} (\textit{Protiv znanstvenika}, latinski \textit{Adversus mathematicos}) u 11 knjiga, osporavajući stavove brojnih mislilaca s područja gramatike, retorike, geometrije, aritmetike, astronomije, muzike, ali i logike, fizike i etike; zbog Sekstove sklonosti citiranju djelo je važno za poznavanje grčke misli općenito.

\section*{O tekstu}

\textgreek[variant=ancient]{Πυρρώνειαι ὑποτυπώσεις} (\textit{Pironove postavke}) obuhvaćaju tri knjige. Prva prikazuje pironovski skepticizam kao određenu vještinu i tumači njegovu nagradu (spokoj) te različite moduse argumentiranja kojima se skeptik služi (ovladavanje njima čini vještinu skeptika) kao i fraze kojima skeptik izražava stav ἐποχή, „suzdržavanje od suda”; pokazuje se i po čemu se pironovski skepticizam razlikuje od sličnih filozofskih škola. Druga i treća knjiga iznose stavove dogmatskih filozofa o logici (II) te fizici i etici (III) uz skeptičke protuargumente. Tako druga i treća knjiga prikazuju vještinu opisanu u prvoj.
...
Sext.\ Emp.\ Pyrrhoneae hypotyposes 3.17–19
...
\item[τὸ αἴτιον] „uzrok”; oblik srednjega roda najčešće označava općenitiji pojam, uzrok postojanja svega; ἡ αἰτία, oblik ženskoga roda, češće označava uzrok pojedinačne pojave spoznaje
\item[πῶς γὰρ ἂν\dots\ γένοιτο\dots\ εἰ μὴ\dots] prilog πῶς otvara mjesto pitanju; §~254, osnove §~325.11; ἂν + optativ stoji u apodozi pogodbene rečenice potencijalnoga oblika, u protazi je također optativ (ovdje neizrečen jer bi se ponavljao isti glagol, sc.\ γένοιτο), §~477%sc. genoito
\item[τῶν φυσικῶν τε καὶ ψυχικῶν] koordinacija ostvarena kombinacijom sastavnih veznika §~513.2; poimeničenje članom svih vrsta riječi, surečenica i rečenica §~373
...
\item[εἰ\dots\ ὑπάρχει, λέξομεν] veznik uvodi zavisnu pogodbenu rečenicu, ovdje realnoga oblika §~475; §~231; §~258
\item[ὡς πρὸς τὴν φύσιν] tehnički naziv Seksta Empirika: „u odnosu na prirodu” (tj.\ ovdje: „stvarno”)
...
\item[μὴ οὔσης] §~315; LSJ εἰμί A.II; participski dio GA (ovdje istovrijednica pogodbene rečenice); tumačenje: da nema pojedinačnog uzroka sve bi nastajalo od svega, kako se sluči
\end{description}
...
\item[ἐν μὲν ταῖς Αἰγυπτίαις Θήβαις\dots\ τὰ δὲ νότια\dots] koordinacija rečeničnih članova parom čestica; Teba je slavni grad u Egiptu, oko 800 kilometara daleko od Sredozemnoga mora, s hramovima u Karnaku i Luksoru, u blizini pustinje; τὰ νότια su južni krajevi%obj. i realia
\item[ποτὲ] neodređeni prilog modificira predikat
\item[ἂν ἐγίνοντο] jonska i helenistička inačica, usp.\ LSJ γίγνομαι; apodoza zavisne pogodbene rečenice irealnoga oblika §~478
\item[οὐ μετεῖχεν] rekcija τινός; §~231, složenica ἔχω; sročnost sa subjektom u množini srednjega roda §~361; apodoza zavisne pogodbene rečenice irealnoga oblika §~478
\item[εἰ μὴ\dots\ ἦν] §~315; LSJ εἰμί A.II; protaza zavisne pogodbene rečenice irealnoga oblika §~478
...
\item[ἐστι δυσχείμερα] sročnost sa subjektom u množini srednjega roda §~361; imenski predikat Smyth 909
\item[αὐχμηρὰ] imenski dio imenskoga predikata (kopula je izostavljena da se izbjegne ponavljanje) Smyth 909
...
\item[δὲ] kopulativno δέ (izvan koordinacije s μέν) označava prijelaz iz rečenice u rečenicu; sljedeća rečenica iskazuje nešto novo ili drukčije, ali ne suprotno prethodnomu iskazu, Smyth 2386
\item[ὁ λέγων] §~231; poimeničenje participa članom §~499; zbog značenja glagolski oblik otvara mjesto A+I
...
\item[λέγειν] §~231
\item[ἄπιστος ἔσται] §~315; imenski predikat Smyth 909; apodoza zavisne pogodbene rečenice realnoga oblika §~475
\item[βουλόμενος] §~232; glagol nepotpuna značenja otvara mjesto dopuni u infinitivu
\item[ἀναιρεῖν] §~243
\item[τίθησιν] sc.\ αὐτό; §~305; LSJ τίθημι B.II
\item[ἀποδιδόσθω] složenica δίδωμι §~305; apodoza pogodbene rečenice realnoga oblika §~475
