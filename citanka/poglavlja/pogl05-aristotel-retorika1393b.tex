...
\tabto{2em} \uuline{ἑλομένων} στρατηγὸν αὐτοκράτορα \\
\tabto{2em} \uuline{τῶν ῾Ιμεραίων} \\
\tabto{3em} Φάλαριν \\
\tabto{2em} καὶ \uuline{μελλόντων} \\
...
\tabto{4em} λειμῶνα \\
\tabto{2em} μόνος, \\
\tabto{2em} \uuline{ἐλθόντος} δ' \uuline{ἐλάφου} \\
\tabto{2em} καὶ \uuline{διαφθείροντος} τὴν νομὴν \\
\tabto{2em} βουλόμενος \\
